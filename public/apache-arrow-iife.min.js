...
(function (global, factory) {
    ...
    function Ha(a, b) {
        return new oa(function* () {
            function c(f) { return new oa(function* () { yield new n(1, Fa(function* (g) { let k = null; do { let m; k = g.next(yield null == (m = k) ? void 0 : m.value) } while (!k.done) }(f[Symbol.iterator]()))) }()) } function d(f) { return new oa(function* () { yield new n(0, yield new n(2, f)) }()) } if (t(b) && q(b.then)) return new n(0, yield new n(1, Ha(a, yield new n(2, b)))); const e = "string" === typeof b ? d(b) : ArrayBuffer.isView(b) ? d(b) : b instanceof ArrayBuffer ? d(b) : b instanceof Ba ? d(b) : t(b) && q(b[Symbol.iterator]) ?
                c(b) : t(b) && q(b[Symbol.asyncIterator]) ? b : d(b); yield new n(1, Fa(function (f) { return new oa(function* () { let g = null; do g = yield new n(2, f.next(yield new n(0, u(a, g)))); while (!g.done) }()) }(e[Symbol.asyncIterator]()))); return new n(0, new a)
        }())
    } function Ja(a, b, c) { if (0 !== a) { c = c.slice(0, b); for (let d = -1, e = c.length; ++d < e;)c[d] += a } return c.subarray(0, b) } function Ka(a, b) { let c = 0; const d = a.length; if (d !== b.length) return !1; if (0 < d) { do if (a[c] !== b[c]) return !1; while (++c < d) } return !0 } var v = {}; v.compareArrayLike = Ka;
    ...
    function Pa(a) {
        return new oa(function* () {
            let b, c = !1, d = [], e, f, g, k = 0; ({ N: f, size: g } = (yield new n(0, null)) || { N: "read", size: 0 }); const m = Ha(Uint8Array, a)[Symbol.asyncIterator](); try { do if ({ done: b, value: e } = Number.isNaN(g - k) ? yield new n(2, m.next()) : yield new n(2, m.next(g - k)), !b && 0 < e.byteLength && (d.push(e), k += e.byteLength), b || g <= k) { do { if ("peek" === f) var p = Ea(d, g)[0]; else[e, d, k] = Ea(d, g), p = e; ({ N: f, size: g } = yield new n(0, p)) } while (g < k) } while (!b) } catch (r) { (c = !0, "function" === typeof m.throw) && (yield new n(2, m.throw(r))) } finally {
                !1 ===
                    c && "function" === typeof m.return && (yield new n(2, m.return(new Uint8Array(0))))
            } return new n(0, null)
        }())
    }
    function Qa(a) {
        return new oa(function* () {
            let b = !1, c = !1, d = [], e, f, g, k = 0; ({ N: f, size: g } = (yield new n(0, null)) || { N: "read", size: 0 }); const m = new Ra(a); try { do if ({ done: b, value: e } = Number.isNaN(g - k) ? yield new n(2, m.read()) : yield new n(2, m.read(g - k)), !b && 0 < e.byteLength && (d.push(u(Uint8Array, e)), k += e.byteLength), b || g <= k) { do { if ("peek" === f) var p = Ea(d, g)[0]; else[e, d, k] = Ea(d, g), p = e; ({ N: f, size: g } = yield new n(0, p)) } while (g < k) } while (!b) } catch (r) { c = !0, yield new n(2, m.cancel(r)) } finally {
                !1 === c ? yield new n(2, m.cancel()) :
                    a.locked && m.releaseLock()
            } return new n(0, null)
        }())
    }
    class Ra {
        constructor(a) { this.source = a; this.W = null; this.W = this.source.getReader(); this.W.closed.catch(() => { }) } get closed() { return this.W ? this.W.closed.catch(() => { }) : Promise.resolve() } releaseLock() { this.W && this.W.releaseLock(); this.W = null } cancel(a) { const b = this; return l(function* () { const c = b.W, d = b.source; c && (yield c.cancel(a).catch(() => { })); d && d.locked && b.releaseLock() }) } read(a) {
            const b = this; return l(function* () {
                if (0 === a) return { done: null == b.W, value: new Uint8Array(0) }; const c = yield b.W.read(); !c.done &&
                    (c.value = u(Uint8Array, c)); return c
            })
        }
    } const Sa = (a, b) => { const c = e => d([b, e]); let d; return [b, c, new Promise(e => (d = e) && a.once(b, c))] };
    function Ta(a) {
        return new oa(function* () {
            function b(sa, Ia) { r = p = null; return new Promise((Jc, ij) => { for (const [Db, jj] of sa) a.off(Db, jj); try { const Db = a.destroy; Db && Db.call(a, Ia); Ia = void 0 } catch (Db) { Ia = Db || Ia } finally { null != Ia ? ij(Ia) : Jc() } }) } const c = []; let d = "error", e = !1, f = null, g, k, m = 0, p = [], r; ({ N: g, size: k } = (yield new n(0, null)) || { N: "read", size: 0 }); if (a.isTTY) return yield new n(0, new Uint8Array(0)), new n(0, null); try {
                c[0] = Sa(a, "end"); c[1] = Sa(a, "error"); do {
                    c[2] = Sa(a, "readable");[d, f] = yield new n(2, Promise.race(c.map(sa =>
                        sa[2]))); if ("error" === d) break; (e = "end" === d) || (Number.isFinite(k - m) ? (r = u(Uint8Array, a.read(k - m)), r.byteLength < k - m && (r = u(Uint8Array, a.read()))) : r = u(Uint8Array, a.read()), 0 < r.byteLength && (p.push(r), m += r.byteLength)); if (e || k <= m) { do { if ("peek" === g) var T = Ea(p, k)[0]; else[r, p, m] = Ea(p, k), T = r; ({ N: g, size: k } = yield new n(0, T)) } while (k < m) }
                } while (!e)
            } finally { yield new n(2, b(c, "error" === d ? f : null)) } return new n(0, null)
        }())
    }; var w, Ua = w || (w = {}); Ua[Ua.V1 = 0] = "V1"; Ua[Ua.V2 = 1] = "V2"; Ua[Ua.V3 = 2] = "V3"; Ua[Ua.V4 = 3] = "V4"; Ua[Ua.V5 = 4] = "V5"; var x, Va = x || (x = {}); Va[Va.Sparse = 0] = "Sparse"; Va[Va.Dense = 1] = "Dense"; var y, Wa = y || (y = {}); Wa[Wa.HALF = 0] = "HALF"; Wa[Wa.SINGLE = 1] = "SINGLE"; Wa[Wa.DOUBLE = 2] = "DOUBLE"; var Xa, Ya = Xa || (Xa = {}); Ya[Ya.DAY = 0] = "DAY"; Ya[Ya.MILLISECOND = 1] = "MILLISECOND"; var z, Za = z || (z = {}); Za[Za.SECOND = 0] = "SECOND"; Za[Za.MILLISECOND = 1] = "MILLISECOND"; Za[Za.MICROSECOND = 2] = "MICROSECOND"; Za[Za.NANOSECOND = 3] = "NANOSECOND"; var $a, ab = $a || ($a = {}); ab[ab.YEAR_MONTH = 0] = "YEAR_MONTH"; ab[ab.DAY_TIME = 1] = "DAY_TIME"; ab[ab.MONTH_DAY_NANO = 2] = "MONTH_DAY_NANO"; const bb = new Int32Array(2); new Float32Array(bb.buffer); new Float64Array(bb.buffer); new Uint16Array((new Uint8Array([1, 0])).buffer); var cb, db = cb || (cb = {}); db[db.UTF8_BYTES = 1] = "UTF8_BYTES"; db[db.UTF16_STRING = 2] = "UTF16_STRING"; function eb(a, b) { return (a.l[b] | a.l[b + 1] << 8) << 16 >> 16 } function fb(a, b) { return BigInt.asIntN(64, BigInt(a.u(b) >>> 0) + (BigInt(a.u(b + 4) >>> 0) << BigInt(32))) } function A(a, b, c) { b -= a.u(b); return c < eb(a, b) ? eb(a, b + c) : 0 } function gb(a, b, c) { b.h = c + a.u(c); b.g = a; return b } function hb(a, b, c) { b += a.u(b); const d = a.u(b); b += 4; b = a.l.subarray(b, b + d); return c === cb.UTF8_BYTES ? b : a.$b.decode(b) } function ib(a, b) { return b + a.u(b) } function jb(a, b) { return b + a.u(b) + 4 } function kb(a, b) { return a.u(b + a.u(b)) }
    ...
    class ic {
        constructor() { this.g = null; this.h = 0 } i(a, b) { this.h = a; this.g = b; return this } name(a) { const b = A(this.g, this.h, 4); return b ? hb(this.g, this.h + b, a) : null } nullable() { const a = A(this.g, this.h, 6); return a ? !!(this.g.l[this.h + a] << 24 >> 24) : !1 } type(a) { const b = A(this.g, this.h, 10); return b ? gb(this.g, a, this.h + b) : null } dictionary(a) { const b = A(this.g, this.h, 12); return b ? (a || new Tb).i(ib(this.g, this.h + b), this.g) : null } children(a, b) {
            const c = A(this.g, this.h, 14); return c ? (b || new ic).i(ib(this.g, jb(this.g, this.h + c) + 4 * a),
                this.g) : null
        } Ga(a) { const b = A(this.g, this.h, 16); return b ? (new Ub).i(ib(this.g, jb(this.g, this.h + b) + 4 * a), this.g) : null } Ha() { const a = A(this.g, this.h, 16); return a ? kb(this.g, this.h + a) : 0 }
    }; function jc(a, b) { xb(a, 4, b.length, 4); for (let c = b.length - 1; 0 <= c; c--)vb(a, b[c]); return yb(a) } function kc(a, b) { xb(a, 4, b.length, 4); for (let c = b.length - 1; 0 <= c; c--)vb(a, b[c]); return yb(a) } function lc(a) { const b = A(a.g, a.h, 6); return b ? kb(a.g, a.h + b) : 0 }
    ...
    class Je extends K {
        constructor(a, b = !1) { super(H.Map); this.children = [a]; this.keysSorted = b; if (a) { a.name = "entries"; let c; if (null == a ? 0 : null == (c = a.type) ? 0 : c.children) { let d; (b = null == a ? void 0 : null == (d = a.type) ? void 0 : d.children[0]) && (b.name = "key"); let e; (a = null == a ? void 0 : null == (e = a.type) ? void 0 : e.children[1]) && (a.name = "value") } } } get keyType() { return this.children[0].type.children[0].type } get valueType() { return this.children[0].type.children[1].type } get childType() { return this.children[0].type } toString() {
            return `Map<{${this.children[0].type.children.map(a =>
                `${a.name}:${a.type}`).join(", ")}}>`
        }
    } var Ke = Symbol.toStringTag, Le, Me = Je.prototype; Me.children = null; Me.keysSorted = null; Le = Me[Symbol.toStringTag] = "Map_"; Je[Ke] = Le; const Ne = (a => () => ++a)(-1);
    ...
    function Ve(a, b, c = !0) {
        let d = null; switch (b) {
            case H.Null: d = a.visitNull; break; case H.Bool: d = a.visitBool; break; case H.Int: d = a.visitInt; break; case H.Int8: d = a.visitInt8 || a.visitInt; break; case H.Int16: d = a.visitInt16 || a.visitInt; break; case H.Int32: d = a.visitInt32 || a.visitInt; break; case H.Int64: d = a.visitInt64 || a.visitInt; break; case H.Uint8: d = a.visitUint8 || a.visitInt; break; case H.Uint16: d = a.visitUint16 || a.visitInt; break; case H.Uint32: d = a.visitUint32 || a.visitInt; break; case H.Uint64: d = a.visitUint64 || a.visitInt;
                ...
                break; case H.IntervalDayTime: d = a.visitIntervalDayTime || a.visitInterval; break; case H.IntervalYearMonth: d = a.visitIntervalYearMonth || a.visitInterval; break; case H.Duration: d = a.visitDuration; break; case H.DurationSecond: d = a.visitDurationSecond || a.visitDuration; break; case H.DurationMillisecond: d = a.visitDurationMillisecond || a.visitDuration; break; case H.DurationMicrosecond: d = a.visitDurationMicrosecond || a.visitDuration; break; case H.DurationNanosecond: d = a.visitDurationNanosecond || a.visitDuration; break; case H.FixedSizeList: d =
                    a.visitFixedSizeList; break; case H.Map: d = a.visitMap
        }if ("function" === typeof d) return d; if (!c) return () => null; throw Error(`Unrecognized type '${H[b]}'`);
    }
    function We(a) {
        switch (a.typeId) {
            case H.Null: return H.Null; case H.Int: const b = a.isSigned; switch (a.bitWidth) { case 8: return b ? H.Int8 : H.Uint8; case 16: return b ? H.Int16 : H.Uint16; case 32: return b ? H.Int32 : H.Uint32; case 64: return b ? H.Int64 : H.Uint64 }return H.Int; case H.Float: switch (a.precision) { case y.HALF: return H.Float16; case y.SINGLE: return H.Float32; case y.DOUBLE: return H.Float64 }return H.Float; case H.Binary: return H.Binary; case H.LargeBinary: return H.LargeBinary; case H.Utf8: return H.Utf8; case H.LargeUtf8: return H.LargeUtf8;
            case H.Bool: return H.Bool; case H.Decimal: return H.Decimal; case H.Time: switch (a.unit) { case z.SECOND: return H.TimeSecond; case z.MILLISECOND: return H.TimeMillisecond; case z.MICROSECOND: return H.TimeMicrosecond; case z.NANOSECOND: return H.TimeNanosecond }return H.Time; case H.Timestamp: switch (a.unit) { case z.SECOND: return H.TimestampSecond; case z.MILLISECOND: return H.TimestampMillisecond; case z.MICROSECOND: return H.TimestampMicrosecond; case z.NANOSECOND: return H.TimestampNanosecond }return H.Timestamp; case H.Date: switch (a.unit) {
                case Xa.DAY: return H.DateDay;
                case Xa.MILLISECOND: return H.DateMillisecond
            }return H.Date; case H.Interval: switch (a.unit) { case $a.DAY_TIME: return H.IntervalDayTime; case $a.YEAR_MONTH: return H.IntervalYearMonth }return H.Interval; case H.Duration: switch (a.unit) { case z.SECOND: return H.DurationSecond; case z.MILLISECOND: return H.DurationMillisecond; case z.MICROSECOND: return H.DurationMicrosecond; case z.NANOSECOND: return H.DurationNanosecond }return H.Duration; case H.Map: return H.Map; case H.List: return H.List; case H.Struct: return H.Struct;
            case H.Union: switch (a.mode) { case x.Dense: return H.DenseUnion; case x.Sparse: return H.SparseUnion }return H.Union; case H.FixedSizeBinary: return H.FixedSizeBinary; case H.FixedSizeList: return H.FixedSizeList; case H.Dictionary: return H.Dictionary
        }throw Error(`Unrecognized type '${H[a.typeId]}'`);
    ...
    const cf = (a, b, c, d) => { if (c + 1 < b.length) { const e = J(b[c]); b = J(b[c + 1]); a.set(d.subarray(0, b - e), e) } }, df = ({ values: a }, b, c) => { a[b] = c }, ef = ({ values: a }, b, c) => { a[b] = c }, ff = ({ values: a }, b, c) => { a[b] = $e(c) }, gf = ({ values: a }, b, c) => { a[b] = Math.floor(c.valueOf() / 864E5) }, hf = ({ values: a }, b, c) => { a[b] = BigInt(c) }, jf = ({ stride: a, values: b }, c, d) => { b.set(d.subarray(0, a), a * c) }, kf = ({ values: a, valueOffsets: b }, c, d) => cf(a, b, c, d), lf = ({ values: a, valueOffsets: b }, c, d) => cf(a, b, c, xa.encode(d)), mf = (a, b, c) => {
        a.type.unit === Xa.DAY ? gf(a, b, c) : hf(a, b,
            c)
    }, nf = ({ values: a }, b, c) => { a[b] = BigInt(c / 1E3) }, of = ({ values: a }, b, c) => { a[b] = BigInt(c) }, pf = ({ values: a }, b, c) => { a[b] = BigInt(1E3 * c) }, qf = ({ values: a }, b, c) => { a[b] = BigInt(1E6 * c) }, rf = (a, b, c) => { switch (a.type.unit) { case z.SECOND: return nf(a, b, c); case z.MILLISECOND: return of(a, b, c); case z.MICROSECOND: return pf(a, b, c); case z.NANOSECOND: return qf(a, b, c) } }, sf = ({ values: a }, b, c) => { a[b] = c }, tf = ({ values: a }, b, c) => { a[b] = c }, uf = ({ values: a }, b, c) => { a[b] = c }, vf = ({ values: a }, b, c) => { a[b] = c }, wf = (a, b, c) => {
        switch (a.type.unit) {
            case z.SECOND: return sf(a,
                b, c); case z.MILLISECOND: return tf(a, b, c); case z.MICROSECOND: return uf(a, b, c); case z.NANOSECOND: return vf(a, b, c)
        }
    }, xf = ({ values: a, stride: b }, c, d) => { a.set(d.subarray(0, b), b * c) }, yf = (a, b) => (c, d, e, f) => d && c(d, a, b[f]), zf = (a, b) => (c, d, e, f) => d && c(d, a, b.get(f)), Af = (a, b) => (c, d, e) => d && c(d, a, b.get(e.name)), Bf = (a, b) => (c, d, e) => d && c(d, a, b[e.name]), Df = (a, b, c) => { Cf.visit(a.children[a.type.typeIdToChildIndex[a.typeIds[b]]], a.valueOffsets[b], c) }, Ef = (a, b, c) => {
        Cf.visit(a.children[a.type.typeIdToChildIndex[a.typeIds[b]]],
            b, c)
    }, Hf = (a, b, c) => { a.type.unit === $a.DAY_TIME ? Ff(a, b, c) : Gf(a, b, c) }, Ff = ({ values: a }, b, c) => { a.set(c.subarray(0, 2), 2 * b) }, Gf = ({ values: a }, b, c) => { a[b] = 12 * c[0] + c[1] % 12 }, If = ({ values: a }, b, c) => { a[b] = c }, Jf = ({ values: a }, b, c) => { a[b] = c }, Kf = ({ values: a }, b, c) => { a[b] = c }, Lf = ({ values: a }, b, c) => { a[b] = c }, Mf = (a, b, c) => { switch (a.type.unit) { case z.SECOND: return If(a, b, c); case z.MILLISECOND: return Jf(a, b, c); case z.MICROSECOND: return Kf(a, b, c); case z.NANOSECOND: return Lf(a, b, c) } }; h = bf.prototype;
    ...
    class Tf {
        isExtensible() { return !1 } deleteProperty() { return !1 } preventExtensions() { return !0 } ownKeys(a) { return a[Nf].type.children.map(b => b.name) } has(a, b) { return a[Nf].type.children.some(c => c.name === b) } getOwnPropertyDescriptor(a, b) { if (a[Nf].type.children.some(c => c.name === b)) return { writable: !0, enumerable: !0, configurable: !0 } } get(a, b) { if (Reflect.has(a, b)) return a[b]; var c = a[Nf].type.children.findIndex(d => d.name === b); if (-1 !== c) return c = Rf.visit(a[Nf].children[c], a[Of]), Reflect.set(a, b, c), c } set(a, b, c) {
            const d =
                a[Nf].type.children.findIndex(e => e.name === b); return -1 !== d ? (Cf.visit(a[Nf].children[d], a[Of], c), Reflect.set(a, b, c)) : Reflect.has(a, b) || "symbol" === typeof b ? Reflect.set(a, b, c) : !1
        }
    } const Qf = new Tf; class Uf extends Te { } function N(a) { return (b, c) => b.getValid(c) ? a(b, c) : null }
    ...
    class wg {
        isExtensible() { return !1 } deleteProperty() { return !1 } preventExtensions() { return !0 } ownKeys(a) { return a[ug] } has(a, b) { return a[ug].includes(b) } getOwnPropertyDescriptor(a, b) { if (-1 !== a[ug].indexOf(b)) return { writable: !0, enumerable: !0, configurable: !0 } } get(a, b) { if (Reflect.has(a, b)) return a[b]; var c = a[ug].indexOf(b); if (-1 !== c) return c = Rf.visit(Reflect.get(a, tg), c), Reflect.set(a, b, c), c } set(a, b, c) {
            const d = a[ug].indexOf(b); return -1 !== d ? (Cf.visit(Reflect.get(a, tg), d, c), Reflect.set(a, b, c)) : Reflect.has(a,
                b) ? Reflect.set(a, b, c) : !1
        }
    ...
    class O {
        get typeId() { return this.type.typeId } get ArrayType() { return this.type.ArrayType } get buffers() { return [this.valueOffsets, this.values, this.nullBitmap, this.typeIds] } get nullable() { if (0 !== this.O) { const a = this.type; return K.isSparseUnion(a) ? this.children.some(b => b.nullable) : K.isDenseUnion(a) ? this.children.some(b => b.nullable) : this.nullBitmap && 0 < this.nullBitmap.byteLength } return !0 } get byteLength() {
            let a = 0; const b = this.valueOffsets, c = this.values, d = this.nullBitmap, e = this.typeIds; b && (a += b.byteLength);
            c && (a += c.byteLength); d && (a += d.byteLength); e && (a += e.byteLength); return this.children.reduce((f, g) => f + g.byteLength, a)
        } get nullCount() { if (K.isUnion(this.type)) return this.children.reduce((c, d) => c + d.nullCount, 0); let a = this.O, b; -1 >= a && (b = this.nullBitmap) && (this.O = a = 0 === b.length ? 0 : this.length - Og(b, this.offset, this.offset + this.length)); return a } constructor(a, b, c, d, e, f = [], g) {
            this.type = a; this.children = f; this.dictionary = g; this.offset = Math.floor(Math.max(b || 0, 0)); this.length = Math.floor(Math.max(c || 0, 0)); this.O =
                Math.floor(Math.max(d || 0, -1)); let k; e instanceof O ? (this.stride = e.stride, this.values = e.values, this.typeIds = e.typeIds, this.nullBitmap = e.nullBitmap, this.valueOffsets = e.valueOffsets) : (this.stride = Se(a), e && ((k = e[0]) && (this.valueOffsets = k), (k = e[1]) && (this.values = k), (k = e[2]) && (this.nullBitmap = k), (k = e[3]) && (this.typeIds = k)))
        } getValid(a) {
            const b = this.type; return K.isUnion(b) ? this.children[b.typeIdToChildIndex[this.typeIds[a]]].getValid(b.mode === x.Dense ? this.valueOffsets[a] : a) : this.nullable && 0 < this.nullCount ?
                (a = this.offset + a, 0 !== (this.nullBitmap[a >> 3] & 1 << a % 8)) : !0
        } setValid(a, b) {
            var c = this.type; if (K.isUnion(c)) { var d = this.children[c.typeIdToChildIndex[this.typeIds[a]]]; a = c.mode === x.Dense ? this.valueOffsets[a] : a; c = d.getValid(a); d.setValid(a, b) } else {
                ({ nullBitmap: d } = this); c = this.offset; var e = this.length, f = c + a; a = 1 << f % 8; f >>= 3; if (!d || d.byteLength <= f) d = (new Uint8Array((c + e + 63 & -64) >> 3)).fill(255), 0 < this.nullCount ? (d.set(Lg(c, e, this.nullBitmap), 0), Object.assign(this, { nullBitmap: d })) : Object.assign(this, {
                    nullBitmap: d,
                    O: 0
                }); e = d[f]; c = 0 !== (e & a); d[f] = b ? e | a : e & ~a
            } c !== !!b && (this.O = this.nullCount + (b ? -1 : 1)); return b
        } clone(a = this.type, b = this.offset, c = this.length, d = this.O, e = this, f = this.children) { return new O(a, b, c, d, e, f, this.dictionary) } slice(a, b) {
            const c = this.stride, d = this.typeId, e = this.children, f = +(0 === this.O) - 1, g = 16 === d ? c : 1; let k; const m = this.buffers; (k = m[sc.TYPE]) && (m[sc.TYPE] = k.subarray(a, a + b)); (k = m[sc.OFFSET]) && (m[sc.OFFSET] = k.subarray(a, a + b + 1)) || (k = m[sc.DATA]) && (m[sc.DATA] = 6 === d ? k : k.subarray(c * a, c * (a + b))); return this.clone(this.type,
                this.offset + a, b, f, m, 0 === e.length || this.valueOffsets ? e : Sg(e, g * a, g * b))
        }
    } O.prototype.children = Object.freeze([]);
    class Ug extends Te {
        visit(a) { return this.getVisitFn(a.type).call(this, a) } visitNull(a) { const { type: b, offset: c = 0, length: d = 0 } = a; return new O(b, c, d, d) } visitBool(a) { const { type: b, offset: c = 0 } = a, d = u(Uint8Array, a.nullBitmap), e = u(b.ArrayType, a.data), { length: f = e.length >> 3, nullCount: g = a.nullBitmap ? -1 : 0 } = a; return new O(b, c, f, g, [void 0, e, d]) } visitInt(a) {
            const { type: b, offset: c = 0 } = a, d = u(Uint8Array, a.nullBitmap), e = u(b.ArrayType, a.data), { length: f = e.length, nullCount: g = a.nullBitmap ? -1 : 0 } = a; return new O(b, c, f, g, [void 0,
                e, d])
        } visitFloat(a) { const { type: b, offset: c = 0 } = a, d = u(Uint8Array, a.nullBitmap), e = u(b.ArrayType, a.data), { length: f = e.length, nullCount: g = a.nullBitmap ? -1 : 0 } = a; return new O(b, c, f, g, [void 0, e, d]) } visitUtf8(a) { const { type: b, offset: c = 0 } = a, d = u(Uint8Array, a.data), e = u(Uint8Array, a.nullBitmap), f = u(Int32Array, a.valueOffsets), { length: g = f.length - 1, nullCount: k = a.nullBitmap ? -1 : 0 } = a; return new O(b, c, g, k, [f, d, e]) } visitLargeUtf8(a) {
            const { type: b, offset: c = 0 } = a, d = u(Uint8Array, a.data), e = u(Uint8Array, a.nullBitmap), f = u(BigInt64Array,
                a.valueOffsets), { length: g = f.length - 1, nullCount: k = a.nullBitmap ? -1 : 0 } = a; return new O(b, c, g, k, [f, d, e])
        } visitBinary(a) { const { type: b, offset: c = 0 } = a, d = u(Uint8Array, a.data), e = u(Uint8Array, a.nullBitmap), f = u(Int32Array, a.valueOffsets), { length: g = f.length - 1, nullCount: k = a.nullBitmap ? -1 : 0 } = a; return new O(b, c, g, k, [f, d, e]) } visitLargeBinary(a) {
            const { type: b, offset: c = 0 } = a, d = u(Uint8Array, a.data), e = u(Uint8Array, a.nullBitmap), f = u(BigInt64Array, a.valueOffsets), { length: g = f.length - 1, nullCount: k = a.nullBitmap ? -1 : 0 } = a; return new O(b,
                c, g, k, [f, d, e])
        } visitFixedSizeBinary(a) { const { type: b, offset: c = 0 } = a, d = u(Uint8Array, a.nullBitmap), e = u(b.ArrayType, a.data), { length: f = e.length / Se(b), nullCount: g = a.nullBitmap ? -1 : 0 } = a; return new O(b, c, f, g, [void 0, e, d]) } visitDate(a) { const { type: b, offset: c = 0 } = a, d = u(Uint8Array, a.nullBitmap), e = u(b.ArrayType, a.data), { length: f = e.length / Se(b), nullCount: g = a.nullBitmap ? -1 : 0 } = a; return new O(b, c, f, g, [void 0, e, d]) } visitTimestamp(a) {
            const { type: b, offset: c = 0 } = a, d = u(Uint8Array, a.nullBitmap), e = u(b.ArrayType, a.data), { length: f =
                e.length / Se(b), nullCount: g = a.nullBitmap ? -1 : 0 } = a; return new O(b, c, f, g, [void 0, e, d])
        } visitTime(a) { const { type: b, offset: c = 0 } = a, d = u(Uint8Array, a.nullBitmap), e = u(b.ArrayType, a.data), { length: f = e.length / Se(b), nullCount: g = a.nullBitmap ? -1 : 0 } = a; return new O(b, c, f, g, [void 0, e, d]) } visitDecimal(a) { const { type: b, offset: c = 0 } = a, d = u(Uint8Array, a.nullBitmap), e = u(b.ArrayType, a.data), { length: f = e.length / Se(b), nullCount: g = a.nullBitmap ? -1 : 0 } = a; return new O(b, c, f, g, [void 0, e, d]) } visitList(a) {
            const { type: b, offset: c = 0, child: d } =
                a, e = u(Uint8Array, a.nullBitmap), f = u(Int32Array, a.valueOffsets), { length: g = f.length - 1, nullCount: k = a.nullBitmap ? -1 : 0 } = a; return new O(b, c, g, k, [f, void 0, e], [d])
        } visitStruct(a) { const { type: b, offset: c = 0, children: d = [] } = a, e = u(Uint8Array, a.nullBitmap), { length: f = d.reduce((k, { length: m }) => Math.max(k, m), 0), nullCount: g = a.nullBitmap ? -1 : 0 } = a; return new O(b, c, f, g, [void 0, void 0, e], d) } visitUnion(a) {
            const { type: b, offset: c = 0, children: d = [] } = a, e = u(b.ArrayType, a.typeIds), { length: f = e.length, nullCount: g = -1 } = a; if (K.isSparseUnion(b)) return new O(b,
                c, f, g, [void 0, void 0, void 0, e], d); a = u(Int32Array, a.valueOffsets); return new O(b, c, f, g, [a, void 0, void 0, e], d)
        } visitDictionary(a) { const { type: b, offset: c = 0 } = a, d = u(Uint8Array, a.nullBitmap), e = u(b.indices.ArrayType, a.data), { dictionary: f = new M([(new Ug).visit({ type: b.dictionary })]) } = a, { length: g = e.length, nullCount: k = a.nullBitmap ? -1 : 0 } = a; return new O(b, c, g, k, [void 0, e, d], [], f) } visitInterval(a) {
            const { type: b, offset: c = 0 } = a, d = u(Uint8Array, a.nullBitmap), e = u(b.ArrayType, a.data), { length: f = e.length / Se(b), nullCount: g =
                a.nullBitmap ? -1 : 0 } = a; return new O(b, c, f, g, [void 0, e, d])
        } visitDuration(a) { const { type: b, offset: c = 0 } = a, d = u(Uint8Array, a.nullBitmap), e = u(b.ArrayType, a.data), { length: f = e.length, nullCount: g = a.nullBitmap ? -1 : 0 } = a; return new O(b, c, f, g, [void 0, e, d]) } visitFixedSizeList(a) { const { type: b, offset: c = 0, child: d = (new Ug).visit({ type: b.valueType }) } = a, e = u(Uint8Array, a.nullBitmap), { length: f = d.length / Se(b), nullCount: g = a.nullBitmap ? -1 : 0 } = a; return new O(b, c, f, g, [void 0, void 0, e], [d]) } visitMap(a) {
            const { type: b, offset: c = 0,
                child: d = (new Ug).visit({ type: b.childType }) } = a, e = u(Uint8Array, a.nullBitmap), f = u(Int32Array, a.valueOffsets), { length: g = f.length - 1, nullCount: k = a.nullBitmap ? -1 : 0 } = a; return new O(b, c, g, k, [f, void 0, e], [d])
        }
    } const Vg = new Ug; function P(a) { return Vg.visit(a) }; class Wg { constructor(a = 0, b) { this.Eb = a; this.Cb = b; this.bb = 0; this.Ab = this.Cb(0) } next() { for (; this.bb < this.Eb;) { const a = this.Ab.next(); if (!a.done) return a; ++this.bb < this.Eb && (this.Ab = this.Cb(this.bb)) } return { done: !0, value: null } } [Symbol.iterator]() { return this } } function Xg(a) { return a.some(b => b.nullable) } function Yg(a) { return a.reduce((b, c) => b + c.nullCount, 0) } function Zg(a) { return a.reduce((b, c, d) => { b[d + 1] = b[d] + c.length; return b }, new Uint32Array(a.length + 1)) }
    ...
    class M {
        constructor(a) {
            a = a[0] instanceof M ? a.flatMap(f => f.data) : a; if (0 === a.length || a.some(f => !(f instanceof O))) throw new TypeError("Vector constructor expects an Array of Data instances."); let b; const c = null == (b = a[0]) ? void 0 : b.type; switch (a.length) {
                case 0: this.j = [0]; break; case 1: const { get: f, set: g, indexOf: k } = lh[c.typeId], m = a[0]; this.isValid = p => m.getValid(p); this.get = p => f(m, p); this.set = (p, r) => g(m, p, r); this.indexOf = p => k(m, p); this.j = [0, m.length]; break; default: Object.setPrototypeOf(this, mh[c.typeId]),
                    this.j = Zg(a)
            }this.data = a; this.type = c; this.stride = Se(c); let d, e; this.numChildren = null != (e = null == (d = c.children) ? void 0 : d.length) ? e : 0; this.length = this.j.at(-1)
        } get byteLength() { return this.data.reduce((a, b) => a + b.byteLength, 0) } get nullable() { return Xg(this.data) } get nullCount() { return Yg(this.data) } get ArrayType() { return this.type.ArrayType } get [Symbol.toStringTag]() { return `${this.VectorName}<${this.type[Symbol.toStringTag]}>` } get VectorName() { return `${H[this.type.typeId]}Vector` } isValid() { return !1 } get() { return null } at(a) {
            return this.get(0 >
                a ? this.length + a : a)
        } set() { } indexOf() { return -1 } includes(a, b) { return -1 < this.indexOf(a, b) } [Symbol.iterator]() { return kh.visit(this) } concat(...a) { return new M(this.data.concat(a.flatMap(b => b.data).flat(Number.POSITIVE_INFINITY))) } slice(a, b) { return new M(zg(this, a, b, ({ data: c, j: d }, e, f) => $g(c, d, e, f))) } toJSON() { return [...this] } toArray() {
            const a = this.data, b = this.length, c = this.stride, d = this.ArrayType; switch (this.type.typeId) {
                case H.Int: case H.Float: case H.Decimal: case H.Time: case H.Timestamp: switch (a.length) {
                    case 0: return new d;
                    case 1: return a[0].values.subarray(0, b * c); default: return a.reduce((e, { values: f, length: g }) => { e.vb.set(f.subarray(0, g * c), e.offset); e.offset += g * c; return e }, { vb: new d(b * c), offset: 0 }).vb
                }
            }return [...this]
        } toString() { return `[${[...this].join()}]` } getChild(a) { let b; return this.getChildAt(null == (b = this.type.children) ? void 0 : b.findIndex(c => c.name === a)) } getChildAt(a) { return -1 < a && a < this.numChildren ? new M(this.data.map(({ children: b }) => b[a])) : null } get isMemoized() {
            return K.isDictionary(this.type) ? this.data[0].dictionary.isMemoized :
                !1
        } memoize() { if (K.isDictionary(this.type)) { const a = new nh(this.data[0].dictionary), b = this.data.map(c => { c = c.clone(); c.dictionary = a; return c }); return new M(b) } return new nh(this) } unmemoize() { if (K.isDictionary(this.type) && this.isMemoized) { const a = this.data[0].dictionary.unmemoize(), b = this.data.map(c => { c = c.clone(); c.dictionary = a; return c }); return new M(b) } return this }
    }
    ...
    class nh extends M {
        constructor(a) {
            super(a.data); const b = this.get, c = this.set, d = this.slice, e = Array(this.length); Object.defineProperty(this, "get", { value(f) { var g = e[f]; if (void 0 !== g) return g; g = b.call(this, f); return e[f] = g } }); Object.defineProperty(this, "set", { value(f, g) { c.call(this, f, g); e[f] = g } }); Object.defineProperty(this, "slice", { value: (f, g) => new nh(d.call(this, f, g)) }); Object.defineProperty(this, "isMemoized", { value: !0 }); Object.defineProperty(this, "unmemoize", { value: () => new M(this.data) }); Object.defineProperty(this,
                "memoize", { value: () => this })
        }
    }
    function oh(a) {
        if (a) {
            if (a instanceof O) return new M([a]); if (a instanceof M) return new M(a.data); if (a.type instanceof K) return new M([P(a)]); if (Array.isArray(a)) return new M(a.flatMap(b => b instanceof O ? [b] : b instanceof M ? b.data : oh(b).data)); if (ArrayBuffer.isView(a)) {
                a instanceof DataView && (a = new Uint8Array(a.buffer)); const b = { offset: 0, length: a.length, nullCount: -1, data: a }; if (a instanceof Int8Array) return new M([P(Object.assign({}, b, { type: new Sc }))]); if (a instanceof Int16Array) return new M([P(Object.assign({}, b,
                    { type: new Tc }))]); if (a instanceof Int32Array) return new M([P(Object.assign({}, b, { type: new Uc }))]); if (a instanceof BigInt64Array) return new M([P(Object.assign({}, b, { type: new Vc }))]); if (a instanceof Uint8Array || a instanceof Uint8ClampedArray) return new M([P(Object.assign({}, b, { type: new Wc }))]); if (a instanceof Uint16Array) return new M([P(Object.assign({}, b, { type: new Xc }))]); if (a instanceof Uint32Array) return new M([P(Object.assign({}, b, { type: new Yc }))]); if (a instanceof BigUint64Array) return new M([P(Object.assign({},
                        b, { type: new Zc }))]); if (a instanceof Float32Array) return new M([P(Object.assign({}, b, { type: new ed }))]); if (a instanceof Float64Array) return new M([P(Object.assign({}, b, { type: new fd }))])
            }
        } throw Error("Unrecognized input");
    }; function ph(a) {
        if (!a || 0 >= a.length) return function () { return !0 }; let b = ""; const c = a.filter(d => d === d); 0 < c.length && (b = `
    switch (x) {${c.map(d => `
        case ${"bigint" !== typeof d ? uc(d) : `${uc(d)}n`}:`).join("")}
            return false;
    }`); a.length !== c.length && (b = `if (x !== x) return false;\n${b}`); return new Function("x", `${b}\nreturn true;`)
    }; function qh(a, b) { a = Math.ceil(a) * b - 1; return (a - a % 64 + 64 || 64) / b } function rh(a, b = 0) { return a.length >= b ? a.subarray(0, b) : Da(new a.constructor(b), a, 0) } function sh(a, b) { if (0 < b) { a.length += b; b = a.length * a.stride; const c = a.buffer.length; b >= c && (a.buffer = rh(a.buffer, 0 === c ? qh(1 * b, a.BYTES_PER_ELEMENT) : qh(2 * b, a.BYTES_PER_ELEMENT))) } return a }
    class th {
        constructor(a, b = 0, c = 1) { this.length = Math.ceil(b / c); this.buffer = new a(this.length); this.stride = c; this.BYTES_PER_ELEMENT = a.BYTES_PER_ELEMENT; this.ArrayType = a } get byteLength() { return Math.ceil(this.length * this.stride) * this.BYTES_PER_ELEMENT } get reservedLength() { return this.buffer.length / this.stride } get reservedByteLength() { return this.buffer.byteLength } set() { return this } append(a) { return this.set(this.length, a) } flush(a = this.length) {
            a = qh(a * this.stride, this.BYTES_PER_ELEMENT); a = rh(this.buffer, a);
            this.clear(); return a
        } clear() { this.length = 0; this.buffer = new this.ArrayType; return this }
    } class uh extends th { get(a) { return this.buffer[a] } set(a, b) { sh(this, a - this.length + 1); this.buffer[a * this.stride] = b; return this } }
    ...
    class wh extends uh { constructor(a) { super(a.OffsetArrayType, 1, 1) } append(a) { return this.set(this.length - 1, a) } set(a, b) { const c = this.length - 1, d = sh(this, a - c + 1).buffer; c < a++ && 0 <= c && d.fill(d[c], c, a); d[a] = d[a - 1] + b; return this } flush(a = this.length - 1) { a > this.length && this.set(a - 1, 4 < this.BYTES_PER_ELEMENT ? BigInt(0) : 0); return super.flush(a + 1) } }; class xh {
        static throughNode() { throw Error('"throughNode" not available in this environment'); } static throughDOM() { throw Error('"throughDOM" not available in this environment'); } constructor({ type: a, nullValues: b }) { this.length = 0; this.finished = !1; this.type = a; this.children = []; this.nullValues = b; this.stride = Se(a); this.D = new vh; b && 0 < b.length && (this.qb = ph(b)) } toVector() { return new M([this.flush()]) } get ArrayType() { return this.type.ArrayType } get nullCount() { return this.D.Yb } get numChildren() { return this.children.length } get byteLength() {
            let a =
                0; const b = this.j, c = this.o, d = this.D, e = this.$, f = this.children; b && (a += b.byteLength); c && (a += c.byteLength); d && (a += d.byteLength); e && (a += e.byteLength); return f.reduce((g, k) => g + k.byteLength, a)
        } get reservedLength() { return this.D.reservedLength } get reservedByteLength() { let a = 0; this.j && (a += this.j.reservedByteLength); this.o && (a += this.o.reservedByteLength); this.D && (a += this.D.reservedByteLength); this.$ && (a += this.$.reservedByteLength); return this.children.reduce((b, c) => b + c.reservedByteLength, a) } get valueOffsets() {
            return this.j ?
                this.j.buffer : null
        } get values() { return this.o ? this.o.buffer : null } get nullBitmap() { return this.D ? this.D.buffer : null } get typeIds() { return this.$ ? this.$.buffer : null } append(a) { return this.set(this.length, a) } isValid(a) { return this.qb(a) } set(a, b) { this.setValid(a, this.isValid(b)) && this.setValue(a, b); return this } setValue(a, b) { this.A(this, a, b) } setValid(a, b) { this.length = this.D.set(a, +b).length; return b } addChild() { throw Error(`Cannot append children to non-nested type "${this.type}"`); } getChildAt(a) {
            return this.children[a] ||
                null
        } flush() { let a, b, c, d; const e = this.type, f = this.length, g = this.nullCount; var k = this.j; const m = this.o, p = this.D; let r; (b = null == (r = this.$) ? void 0 : r.flush(f)) ? d = null == k ? void 0 : k.flush(f) : a = (d = null == k ? void 0 : k.flush(f)) ? null == m ? void 0 : m.flush(k.get(k.length - 1)) : null == m ? void 0 : m.flush(f); 0 < g && (c = null == p ? void 0 : p.flush(f)); k = this.children.map(T => T.flush()); this.clear(); return P({ type: e, length: f, nullCount: g, children: k, child: k[0], data: a, typeIds: b, nullBitmap: c, valueOffsets: d }) } finish() {
            this.finished = !0; for (const a of this.children) a.finish();
            return this
        } clear() { this.length = 0; let a; null == (a = this.D) || a.clear(); let b; null == (b = this.o) || b.clear(); let c; null == (c = this.j) || c.clear(); let d; null == (d = this.$) || d.clear(); for (const e of this.children) e.clear(); return this }
    } h = xh.prototype; h.length = 1; h.stride = 1; h.children = null; h.finished = !1; h.nullValues = null; h.qb = () => !0; class yh extends xh { constructor(a) { super(a); this.o = new uh(this.ArrayType, 0, this.stride) } setValue(a, b) { const c = this.o; sh(c, a - c.length + 1); return super.setValue(a, b) } }
    function zh(a) { const b = a.G, c = a.J; a.J = 0; a.G = void 0; b && 0 < b.size && a.U(b, c) }
    class Ah extends xh { constructor(a) { super(a); this.J = 0; this.j = new wh(a.type) } setValue(a, b) { const c = this.G || (this.G = new Map), d = c.get(a); d && (this.J -= d.length); this.J += b instanceof rg ? b[sg].length : b.length; c.set(a, b) } setValid(a, b) { return super.setValid(a, b) ? !0 : ((this.G || (this.G = new Map)).set(a, void 0), !1) } clear() { this.J = 0; this.G = void 0; return super.clear() } flush() { zh(this); return super.flush() } finish() { zh(this); return super.finish() } }; class Bh { constructor() { this.g = null; this.h = 0 } i(a, b) { this.h = a; this.g = b; return this } offset() { return fb(this.g, this.h) } cb() { return this.g.u(this.h + 8) } bodyLength() { return fb(this.g, this.h + 16) } }; class Ch {
        constructor() { this.g = null; this.h = 0 } i(a, b) { this.h = a; this.g = b; return this } version() { const a = A(this.g, this.h, 4); return a ? eb(this.g, this.h + a) : w.V1 } schema(a) { const b = A(this.g, this.h, 6); return b ? (a || new mc).i(ib(this.g, this.h + b), this.g) : null } dictionaries(a, b) { const c = A(this.g, this.h, 8); return c ? (b || new Bh).i(jb(this.g, this.h + c) + 24 * a, this.g) : null } ib(a) { const b = A(this.g, this.h, 10); return b ? (new Bh).i(jb(this.g, this.h + b) + 24 * a, this.g) : null } Ga(a) {
            const b = A(this.g, this.h, 12); return b ? (new Ub).i(ib(this.g,
                jb(this.g, this.h + b) + 4 * a), this.g) : null
        } Ha() { const a = A(this.g, this.h, 12); return a ? kb(this.g, this.h + a) : 0 }
    }; class S {
        constructor(a = [], b, c, d = w.V5) { this.fields = a || []; this.metadata = b || new Map; c || (c = Dh(this.fields)); this.dictionaries = c; this.Ka = d } get [Symbol.toStringTag]() { return "Schema" } get names() { return this.fields.map(a => a.name) } toString() { return `Schema<{ ${this.fields.map((a, b) => `${b}: ${a}`).join(", ")} }>` } select(a) { const b = new Set(a); a = this.fields.filter(c => b.has(c.name)); return new S(a, this.metadata) } selectAt(a) { a = a.map(b => this.fields[b]).filter(Boolean); return new S(a, this.metadata) } assign(...a) {
            var b =
                a[0] instanceof S ? a[0] : Array.isArray(a[0]) ? new S(a[0]) : new S(a); const c = [...this.fields]; a = Eh(Eh(new Map, this.metadata), b.metadata); b = b.fields.filter(e => { const f = c.findIndex(g => g.name === e.name); return ~f ? (c[f] = e.clone({ metadata: Eh(Eh(new Map, c[f].metadata), e.metadata) })) && !1 : !0 }); const d = Dh(b, new Map); return new S([...c, ...b], a, new Map([...this.dictionaries, ...d]))
        }
    } S.prototype.fields = null; S.prototype.metadata = null; S.prototype.dictionaries = null;
    class U {
        static new(...a) { let [b, c, d, e] = a; a[0] && "object" === typeof a[0] && ({ name: b } = a[0], void 0 === c && (c = a[0].type), void 0 === d && (d = a[0].nullable), void 0 === e && (e = a[0].metadata)); return new U(`${b}`, c, d, e) } constructor(a, b, c = !1, d) { this.name = a; this.type = b; this.nullable = c; this.metadata = d || new Map } get typeId() { return this.type.typeId } get [Symbol.toStringTag]() { return "Field" } toString() { return `${this.name}: ${this.type}` } clone(...a) {
            let [b, c, d, e] = a; a[0] && "object" === typeof a[0] ? {
                name: b = this.name, type: c = this.type,
                nullable: d = this.nullable, metadata: e = this.metadata
            } = a[0] : [b = this.name, c = this.type, d = this.nullable, e = this.metadata] = a; return U.new(b, c, d, e)
        }
    } U.prototype.type = null; U.prototype.name = null; U.prototype.nullable = null; U.prototype.metadata = null; function Eh(a, b) { return new Map([...(a || new Map), ...(b || new Map)]) }
    ...
    class Gh {
        static decode(a) { a = new lb(u(Uint8Array, a)); a = (new Ch).i(a.u(a.position()) + a.position(), a); const b = S.decode(a.schema(), new Map, a.version()); return new Hh(b, a) } static encode(a) { const b = new Ab; var c = S.encode(b, a.schema); xb(b, 24, a.numRecordBatches, 8); for (var d of [...a.ib()].slice().reverse()) Ih.encode(b, d); d = yb(b); xb(b, 24, a.numDictionaries, 8); for (const e of [...Fh(a)].slice().reverse()) Ih.encode(b, e); a = yb(b); C(b, 5); B(b, 1, c); sb(b, w.V5, w.V1); B(b, 3, d); B(b, 2, a); c = D(b); b.finish(c); return mb(b) } get numRecordBatches() { return this.ba.length } get numDictionaries() { return this.ob.length } constructor(a,
    ...
    class Oh extends Nh {
        constructor() { super(); this.o = []; this.ia = []; this.Oa = new Promise(a => this.L = a) } get closed() { return this.Oa } cancel(a) { const b = this; return l(function* () { yield b.return(a) }) } write(a) { if (!this.L) throw Error("AsyncQueue is closed"); 0 >= this.ia.length ? this.o.push(a) : this.ia.shift().resolve({ done: !1, value: a }) } abort(a) { this.L && (0 >= this.ia.length ? this.Ra = { error: a } : this.ia.shift().reject({ done: !0, value: a })) } close() {
            if (this.L) {
                const a = this.ia; for (; 0 < a.length;)a.shift().resolve(Jh); this.L(); this.L =
                    void 0
            }
        } [Symbol.asyncIterator]() { return this } toDOMStream(a) { return La(this.L || this.Ra ? this : this.o, a) } toNodeStream() { return Ma() } throw(a) { const b = this; return l(function* () { yield b.abort(a); return Jh }) } return() { const a = this; return l(function* () { yield a.close(); return Jh }) } read(a) { const b = this; return l(function* () { return (yield b.next(a, "read")).value }) } peek(a) { const b = this; return l(function* () { return (yield b.next(a, "peek")).value }) } next() {
            return 0 < this.o.length ? Promise.resolve({ done: !1, value: this.o.shift() }) :
                this.Ra ? Promise.reject({ done: !0, value: this.Ra.error }) : this.L ? new Promise((a, b) => { this.ia.push({ resolve: a, reject: b }) }) : Promise.resolve(Jh)
        }
    }; class Ph extends Oh {
        write(a) { if (0 < (a = u(Uint8Array, a)).byteLength) return super.write(a) } toString(a = !1) { return a ? va.decode(this.toUint8Array(!0)) : this.toUint8Array(!1).then(wa) } toUint8Array(a = !1) {
            return a ? Ea(this.o)[0] : (() => {
                const b = this; return l(function* () {
                    const c = []; let d = 0; var e; try { for (var f = ia(b); ;) { var g = yield f.next(); if (g.done) break; const m = g.value; c.push(m); d += m.byteLength } } catch (m) { var k = { error: m } } finally { try { g && !g.done && (e = f.return) && (yield e.call(f)) } finally { if (k) throw k.error; } } return Ea(c,
                        d)[0]
                })
            })()
        }
    } class Qh { constructor(a) { a && (this.source = new Rh(Na(Oa(a)))) } [Symbol.iterator]() { return this } next(a) { return this.source.next(a) } throw(a) { return this.source.throw(a) } return(a) { return this.source.return(a) } peek(a) { return this.source.peek(a) } read(a) { return this.source.read(a) } }
    ...
    class Th {
        constructor(a) { this.source = a; this.Oa = new Promise(b => this.L = b) } cancel(a) { const b = this; return l(function* () { yield b.return(a) }) } get closed() { return this.Oa } read(a) { const b = this; return l(function* () { return (yield b.next(a, "read")).value }) } peek(a) { const b = this; return l(function* () { return (yield b.next(a, "peek")).value }) } next(a, b = "read") { const c = this; return l(function* () { return yield c.source.next({ N: b, size: a }) }) } throw(a) {
            const b = this; return l(function* () {
                const c = b.source.throw && (yield b.source.throw(a)) ||
                    Jh; b.L && b.L(); b.L = void 0; return Object.create(c)
            })
        } return(a) { const b = this; return l(function* () { const c = b.source.return && (yield b.source.return(a)) || Jh; b.L && b.L(); b.L = void 0; return Object.create(c) }) }
    }; class Uh extends Qh {
        constructor(a) { super(); this.position = 0; this.buffer = u(Uint8Array, a); this.size = this.buffer.byteLength } u(a) { const { buffer: b, byteOffset: c } = this.ha(a, 4); return (new DataView(b, c)).getInt32(0, !0) } seek(a) { this.position = Math.min(a, this.size); return a < this.size } read(a) { const b = this.buffer, c = this.size, d = this.position; return b && d < c ? ("number" !== typeof a && (a = Number.POSITIVE_INFINITY), this.position = Math.min(c, d + Math.min(c - d, a)), b.subarray(d, this.position)) : null } ha(a, b) {
            const c = this.buffer, d =
                Math.min(this.size, a + b); return c ? c.subarray(a, d) : new Uint8Array(b)
        } close() { this.buffer && (this.buffer = null) } throw(a) { this.close(); return { done: !0, value: a } } return(a) { this.close(); return { done: !0, value: a } }
    }
    class Vh extends Sh {
        constructor(a, b) { super(); this.position = 0; this.I = a; "number" === typeof b ? this.size = b : this.G = (() => { const c = this; return l(function* () { c.size = (yield a.stat()).size; delete c.G }) })() } u(a) { const b = this; return l(function* () { const { buffer: c, byteOffset: d } = yield b.ha(a, 4); return (new DataView(c, d)).getInt32(0, !0) }) } seek(a) { const b = this; return l(function* () { b.G && (yield b.G); b.position = Math.min(a, b.size); return a < b.size }) } read(a) {
            const b = this; return l(function* () {
                b.G && (yield b.G); const c = b.I;
                var d = b.size, e = b.position; if (c && e < d) { "number" !== typeof a && (a = Number.POSITIVE_INFINITY); let f = 0, g = 0; d = Math.min(d, e + Math.min(d - e, a)); const k = new Uint8Array(Math.max(0, (b.position = d) - e)); for (; (e += g) < d && (f += g) < k.byteLength;)({ fc: g } = yield c.read(k, f, k.byteLength - f, e)); return k } return null
            })
        } ha(a, b) { const c = this; return l(function* () { c.G && (yield c.G); const d = c.I; var e = c.size; return d && a + b < e ? (e = new Uint8Array(Math.min(e, a + b) - a), (yield d.read(e, 0, b, a)).buffer) : new Uint8Array(b) }) } close() {
            const a = this; return l(function* () {
                const b =
                    a.I; a.I = null; b && (yield b.close())
            })
        } throw(a) { const b = this; return l(function* () { yield b.close(); return { done: !0, value: a } }) } return(a) { const b = this; return l(function* () { yield b.close(); return { done: !0, value: a } }) }
    }; function Wh(a) { 0 > a && (a = 4294967295 + a + 1); return `0x${a.toString(16)}` } const Xh = [1, 10, 100, 1E3, 1E4, 1E5, 1E6, 1E7, 1E8];
    ...
    class bi {
        constructor(a) { this.buffer = a } high() { return new ai(new Uint32Array(this.buffer.buffer, this.buffer.byteOffset + 8, 2)) } low() { return new ai(new Uint32Array(this.buffer.buffer, this.buffer.byteOffset, 2)) } negate() { this.buffer[0] = ~this.buffer[0] + 1; this.buffer[1] = ~this.buffer[1]; this.buffer[2] = ~this.buffer[2]; this.buffer[3] = ~this.buffer[3]; 0 == this.buffer[0] && ++this.buffer[1]; 0 == this.buffer[1] && ++this.buffer[2]; 0 == this.buffer[2] && ++this.buffer[3]; return this } times(a) {
            const b = new V(new Uint32Array([this.buffer[3],
                0])), c = new V(new Uint32Array([this.buffer[2], 0])), d = new V(new Uint32Array([this.buffer[1], 0])), e = new V(new Uint32Array([this.buffer[0], 0])), f = new V(new Uint32Array([a.buffer[3], 0])), g = new V(new Uint32Array([a.buffer[2], 0])), k = new V(new Uint32Array([a.buffer[1], 0])); a = new V(new Uint32Array([a.buffer[0], 0])); let m = V.multiply(e, a); this.buffer[0] = m.low(); const p = new V(new Uint32Array([m.high(), 0])); m = V.multiply(d, a); p.plus(m); m = V.multiply(e, k); p.plus(m); this.buffer[1] = p.low(); this.buffer[3] = p.lessThan(m) ?
                    1 : 0; this.buffer[2] = p.high(); (new V(new Uint32Array(this.buffer.buffer, this.buffer.byteOffset + 8, 2))).plus(V.multiply(c, a)).plus(V.multiply(d, k)).plus(V.multiply(e, g)); this.buffer[3] += V.multiply(b, a).plus(V.multiply(c, k)).plus(V.multiply(d, g)).plus(V.multiply(e, f)).low(); return this
        } plus(a) {
            const b = new Uint32Array(4); b[3] = this.buffer[3] + a.buffer[3] >>> 0; b[2] = this.buffer[2] + a.buffer[2] >>> 0; b[1] = this.buffer[1] + a.buffer[1] >>> 0; b[0] = this.buffer[0] + a.buffer[0] >>> 0; b[0] < this.buffer[0] >>> 0 && ++b[1]; b[1] < this.buffer[1] >>>
                0 && ++b[2]; b[2] < this.buffer[2] >>> 0 && ++b[3]; this.buffer[3] = b[3]; this.buffer[2] = b[2]; this.buffer[1] = b[1]; this.buffer[0] = b[0]; return this
        } hex() { return `${Wh(this.buffer[3])} ${Wh(this.buffer[2])} ${Wh(this.buffer[1])} ${Wh(this.buffer[0])}` } static multiply(a, b) { return (new bi(new Uint32Array(a.buffer))).times(b) } static add(a, b) { return (new bi(new Uint32Array(a.buffer))).plus(b) } static from(a, b = new Uint32Array(4)) { return bi.fromString("string" === typeof a ? a : a.toString(), b) } static fromNumber(a, b = new Uint32Array(4)) {
            return bi.fromString(a.toString(),
                b)
        } static fromString(a, b = new Uint32Array(4)) { const c = a.startsWith("-"), d = a.length; b = new bi(b); for (let e = c ? 1 : 0; e < d;) { const f = 8 < d - e ? 8 : d - e, g = new bi(new Uint32Array([Number.parseInt(a.slice(e, e + f), 10), 0, 0, 0])), k = new bi(new Uint32Array([Xh[f], 0, 0, 0])); b.times(k); b.plus(g); e += f } return c ? b.negate() : b } static convertArray(a) { const b = new Uint32Array(4 * a.length); for (let c = -1, d = a.length; ++c < d;)bi.from(a[c], new Uint32Array(b.buffer, b.byteOffset + 16 * c, 4)); return b }
    } var ci = {}; ci.BaseInt64 = $h; ci.Int128 = bi;
    ...
    class ei extends Te {
        constructor(a, b, c, d, e = w.V5) { super(); this.Wb = this.Xb = -1; this.T = a; this.M = b; this.buffers = c; this.dictionaries = d; this.Ka = e } visit(a) { return super.visit(a instanceof U ? a.type : a) } visitNull(a, { length: b } = W(this)) { return P({ type: a, length: b }) } visitBool(a, { length: b, nullCount: c } = W(this)) { return P({ type: a, length: b, nullCount: c, nullBitmap: this.C(a, c), data: this.F(a) }) } visitInt(a, { length: b, nullCount: c } = W(this)) { return P({ type: a, length: b, nullCount: c, nullBitmap: this.C(a, c), data: this.F(a) }) } visitFloat(a,
            { length: b, nullCount: c } = W(this)) { return P({ type: a, length: b, nullCount: c, nullBitmap: this.C(a, c), data: this.F(a) }) } visitUtf8(a, { length: b, nullCount: c } = W(this)) { return P({ type: a, length: b, nullCount: c, nullBitmap: this.C(a, c), valueOffsets: this.ca(a), data: this.F(a) }) } visitLargeUtf8(a, { length: b, nullCount: c } = W(this)) { return P({ type: a, length: b, nullCount: c, nullBitmap: this.C(a, c), valueOffsets: this.ca(a), data: this.F(a) }) } visitBinary(a, { length: b, nullCount: c } = W(this)) {
                return P({
                    type: a, length: b, nullCount: c, nullBitmap: this.C(a,
                        c), valueOffsets: this.ca(a), data: this.F(a)
                })
            } visitLargeBinary(a, { length: b, nullCount: c } = W(this)) { return P({ type: a, length: b, nullCount: c, nullBitmap: this.C(a, c), valueOffsets: this.ca(a), data: this.F(a) }) } visitFixedSizeBinary(a, { length: b, nullCount: c } = W(this)) { return P({ type: a, length: b, nullCount: c, nullBitmap: this.C(a, c), data: this.F(a) }) } visitDate(a, { length: b, nullCount: c } = W(this)) { return P({ type: a, length: b, nullCount: c, nullBitmap: this.C(a, c), data: this.F(a) }) } visitTimestamp(a, { length: b, nullCount: c } = W(this)) {
                return P({
                    type: a,
                    length: b, nullCount: c, nullBitmap: this.C(a, c), data: this.F(a)
                })
            } visitTime(a, { length: b, nullCount: c } = W(this)) { return P({ type: a, length: b, nullCount: c, nullBitmap: this.C(a, c), data: this.F(a) }) } visitDecimal(a, { length: b, nullCount: c } = W(this)) { return P({ type: a, length: b, nullCount: c, nullBitmap: this.C(a, c), data: this.F(a) }) } visitList(a, { length: b, nullCount: c } = W(this)) { return P({ type: a, length: b, nullCount: c, nullBitmap: this.C(a, c), valueOffsets: this.ca(a), child: this.visit(a.children[0]) }) } visitStruct(a, { length: b, nullCount: c } =
                W(this)) { return P({ type: a, length: b, nullCount: c, nullBitmap: this.C(a, c), children: this.visitMany(a.children) }) } visitUnion(a, { length: b, nullCount: c } = W(this)) { this.Ka < w.V5 && this.C(a, c); return a.mode === x.Sparse ? this.visitSparseUnion(a, { length: b, nullCount: c }) : this.visitDenseUnion(a, { length: b, nullCount: c }) } visitDenseUnion(a, { length: b, nullCount: c } = W(this)) { return P({ type: a, length: b, nullCount: c, typeIds: this.hb(a), valueOffsets: this.ca(a), children: this.visitMany(a.children) }) } visitSparseUnion(a, { length: b, nullCount: c } =
                    W(this)) { return P({ type: a, length: b, nullCount: c, typeIds: this.hb(a), children: this.visitMany(a.children) }) } visitDictionary(a, { length: b, nullCount: c } = W(this)) { return P({ type: a, length: b, nullCount: c, nullBitmap: this.C(a, c), data: this.F(a.indices), dictionary: this.dictionaries.get(a.id) }) } visitInterval(a, { length: b, nullCount: c } = W(this)) { return P({ type: a, length: b, nullCount: c, nullBitmap: this.C(a, c), data: this.F(a) }) } visitDuration(a, { length: b, nullCount: c } = W(this)) {
                        return P({
                            type: a, length: b, nullCount: c, nullBitmap: this.C(a,
                                c), data: this.F(a)
                        })
                    } visitFixedSizeList(a, { length: b, nullCount: c } = W(this)) { return P({ type: a, length: b, nullCount: c, nullBitmap: this.C(a, c), child: this.visit(a.children[0]) }) } visitMap(a, { length: b, nullCount: c } = W(this)) { return P({ type: a, length: b, nullCount: c, nullBitmap: this.C(a, c), valueOffsets: this.ca(a), child: this.visit(a.children[0]) }) } C(a, b) { var c = di(this); return 0 < b && this.F(a, c) || new Uint8Array(0) } ca(a) { return this.F(a) } hb(a) { return this.F(a) } F(a, { length: b, offset: c } = di(this)) {
                        return this.T.subarray(c, c +
                            b)
                    }
    }
    class fi extends ei {
        constructor(a, b, c, d, e) { super(new Uint8Array(0), b, c, d, e); this.sources = a } C(a, b) { ({ offset: a } = di(this)); return 0 >= b ? new Uint8Array(0) : Mg(this.sources[a]) } ca(a) { var { offset: b } = di(this); return u(Uint8Array, u(a.OffsetArrayType, this.sources[b])) } hb(a) { var { offset: b } = di(this); return u(Uint8Array, u(a.ArrayType, this.sources[b])) } F(a, { offset: b } = di(this)) {
            const c = this.sources; return K.isTimestamp(a) || (K.isInt(a) || K.isTime(a)) && 64 === a.bitWidth || K.isDuration(a) || K.isDate(a) && a.unit === Xa.MILLISECOND ? u(Uint8Array,
                ai.convertArray(c[b])) : K.isDecimal(a) ? u(Uint8Array, bi.convertArray(c[b])) : K.isBinary(a) || K.isLargeBinary(a) || K.isFixedSizeBinary(a) ? gi(c[b]) : K.isBool(a) ? Mg(c[b]) : K.isUtf8(a) || K.isLargeUtf8(a) ? xa.encode(c[b].join("")) : u(Uint8Array, u(a.ArrayType, c[b].map(d => +d)))
        }
    } function gi(a) { a = a.join(""); const b = new Uint8Array(a.length / 2); for (let c = 0; c < a.length; c += 2)b[c >> 1] = Number.parseInt(a.slice(c, c + 2), 16); return b }; class hi extends Ah { constructor(a) { super(a); this.o = new th(Uint8Array) } get byteLength() { let a = this.J + 4 * this.length; this.j && (a += this.j.byteLength); this.o && (a += this.o.byteLength); this.D && (a += this.D.byteLength); return a } setValue(a, b) { return super.setValue(a, u(Uint8Array, b)) } U(a, b) { const c = this.j; b = sh(this.o, b).buffer; let d = 0; for (const [e, f] of a) void 0 === f ? c.set(e, 0) : (a = f.length, b.set(f, d), c.set(e, a), d += a) } }; class ii extends Ah { constructor(a) { super(a); this.o = new th(Uint8Array) } get byteLength() { let a = this.J + 4 * this.length; this.j && (a += this.j.byteLength); this.o && (a += this.o.byteLength); this.D && (a += this.D.byteLength); return a } setValue(a, b) { return super.setValue(a, u(Uint8Array, b)) } U(a, b) { const c = this.j; b = sh(this.o, b).buffer; let d = 0; for (const [e, f] of a) void 0 === f ? c.set(e, BigInt(0)) : (a = f.length, b.set(f, d), c.set(e, BigInt(a)), d += a) } }; class ji extends xh { constructor(a) { super(a); this.o = new vh } setValue(a, b) { this.o.set(a, +b) } }; class ki extends yh { } ki.prototype.A = mf; class li extends ki { } li.prototype.A = gf; class mi extends ki { } mi.prototype.A = hf; class ni extends yh { } ni.prototype.A = xf; class oi extends xh {
        constructor({ type: a, nullValues: b, dictionaryHashFunction: c }) { super({ type: new Oe(a.dictionary, a.indices, a.id, a.isOrdered) }); this.D = null; this.za = 0; this.rb = Object.create(null); this.indices = pi({ type: this.type.indices, nullValues: b }); this.dictionary = pi({ type: this.type.dictionary, nullValues: null }); "function" === typeof c && (this.valueToKey = c) } get values() { return this.indices.values } get nullCount() { return this.indices.nullCount } get nullBitmap() { return this.indices.nullBitmap } get byteLength() {
            return this.indices.byteLength +
                this.dictionary.byteLength
        } get reservedLength() { return this.indices.reservedLength + this.dictionary.reservedLength } get reservedByteLength() { return this.indices.reservedByteLength + this.dictionary.reservedByteLength } isValid(a) { return this.indices.isValid(a) } setValid(a, b) { const c = this.indices; b = c.setValid(a, b); this.length = c.length; return b } setValue(a, b) { const c = this.rb, d = this.valueToKey(b); let e = c[d]; void 0 === e && (c[d] = e = this.za + this.dictionary.append(b).length - 1); return this.indices.setValue(a, e) } flush() {
            var a =
                this.type; const b = this.Nb, c = this.dictionary.toVector(); a = this.indices.flush().clone(a); a.dictionary = b ? b.concat(c) : c; this.finished || (this.za += c.length); this.Nb = a.dictionary; this.clear(); return a
        } finish() { this.indices.finish(); this.dictionary.finish(); this.za = 0; this.rb = Object.create(null); return super.finish() } clear() { this.indices.clear(); this.dictionary.clear(); return super.clear() } valueToKey(a) { return "string" === typeof a ? a : `${a}` }
    }; class qi extends yh { } qi.prototype.A = jf; class ri extends xh { setValue(a, b) { const [c] = this.children; a *= this.stride; for (let d = -1, e = b.length; ++d < e;)c.set(a + d, b[d]) } addChild(a, b = "0") { if (0 < this.numChildren) throw Error("FixedSizeListBuilder can only have one child."); const c = this.children.push(a); this.type = new Fe(this.type.listSize, new U(b, a.type, !0)); return c } }; class si extends yh { setValue(a, b) { this.o.set(a, b) } } class ti extends si { setValue(a, b) { super.setValue(a, $e(b)) } } class ui extends si { } class vi extends si { }; class wi extends yh { } wi.prototype.A = Hf; class xi extends wi { } xi.prototype.A = Ff; class yi extends wi { } yi.prototype.A = Gf; class zi extends yh { } zi.prototype.A = Mf; class Ai extends zi { } Ai.prototype.A = If; class Bi extends zi { } Bi.prototype.A = Jf; class Ci extends zi { } Ci.prototype.A = Kf; class Di extends zi { } Di.prototype.A = Lf; class Ei extends yh { setValue(a, b) { this.o.set(a, b) } } class Fi extends Ei { } class Gi extends Ei { } class Hi extends Ei { } class Ii extends Ei { } class Ji extends Ei { } class Ki extends Ei { } class Li extends Ei { } class Mi extends Ei { }; class Ni extends Ah { constructor(a) { super(a); this.j = new wh(a.type) } addChild(a, b = "0") { if (0 < this.numChildren) throw Error("ListBuilder can only have one child."); this.children[this.numChildren] = a; this.type = new ne(new U(b, a.type, !0)); return this.numChildren - 1 } U(a) { const b = this.j, [c] = this.children; for (const [d, e] of a) if ("undefined" === typeof e) b.set(d, 0); else { a = e; const f = a.length, g = b.set(d, f).buffer[d]; for (let k = -1; ++k < f;)c.set(g + k, a[k]) } } }; class Oi extends Ah {
        set(a, b) { return super.set(a, b) } setValue(a, b) { b = b instanceof Map ? b : new Map(Object.entries(b)); const c = this.G || (this.G = new Map), d = c.get(a); d && (this.J -= d.size); this.J += b.size; c.set(a, b) } addChild(a, b = `${this.numChildren}`) { if (0 < this.numChildren) throw Error("ListBuilder can only have one child."); this.children[this.numChildren] = a; this.type = new Je(new U(b, a.type, !0), this.type.keysSorted); return this.numChildren - 1 } U(a) {
            const b = this.j, [c] = this.children; for (const [d, e] of a) if (void 0 ===
                e) b.set(d, 0); else { let { [d]: f, [d + 1]: g } = b.set(d, e.size).buffer; for (const k of e.entries()) if (c.set(f, k), ++f >= g) break }
        }
    }; class Pi extends xh { setValue() { } setValid(a, b) { this.length = Math.max(a + 1, this.length); return b } }; class Qi extends xh {
    ...
    }; class Ri extends yh { } Ri.prototype.A = rf; class Si extends Ri { } Si.prototype.A = nf; class Ti extends Ri { } Ti.prototype.A = of; class Ui extends Ri { } Ui.prototype.A = pf; class Vi extends Ri { } Vi.prototype.A = qf; class Wi extends yh { } Wi.prototype.A = wf; class Xi extends Wi { } Xi.prototype.A = sf; class Yi extends Wi { } Yi.prototype.A = tf; class Zi extends Wi { } Zi.prototype.A = uf; class $i extends Wi { } $i.prototype.A = vf; class aj extends xh {
        constructor(a) { super(a); this.$ = new uh(Int8Array, 0, 1); "function" === typeof a.valueToChildTypeId && (this.tb = a.valueToChildTypeId) } get typeIdToChildIndex() { return this.type.typeIdToChildIndex } append(a, b) { return this.set(this.length, a, b) } set(a, b, c) { void 0 === c && (c = this.tb(this, b, a)); this.setValue(a, b, c); return this } setValue(a, b, c) { this.$.set(a, c); let d; null == (d = this.children[this.type.typeIdToChildIndex[c]]) || d.set(a, b) } addChild(a, b = `${this.children.length}`) {
            const c = this.children.push(a),
                d = this.type, e = d.mode, f = d.typeIds; a = [...d.children, new U(b, a.type)]; this.type = new ve(e, [...f, c], a); return c
        } tb() { throw Error("Cannot map UnionBuilder value to child typeId. Pass the `childTypeId` as the second argument to unionBuilder.append(), or supply a `valueToChildTypeId` function as part of the UnionBuilder constructor options."); }
    } class bj extends aj { }
    ...
    function Dj(a, b, c, d, e) { const f = (b + 63 & -64) >> 3; for (let k = -1, m = d.length; ++k < m;) { const p = c[k]; let r; var g = null == (r = p) ? void 0 : r.length; if (g >= b) g === b ? c[k] = p : (c[k] = p.slice(0, b), e.eb = Math.max(e.eb, d[k].unshift(p.slice(b, g - b)))); else { g = a[k]; a[k] = g.clone({ nullable: !0 }); let T, sa; c[k] = null != (sa = null == (T = p) ? void 0 : Tg(T, b)) ? sa : P({ type: g.type, length: b, nullCount: b, nullBitmap: new Uint8Array(f) }) } } return c }; class Ej {
        constructor(...a) {
            if (0 === a.length) return this.batches = [], this.schema = new S([]), this.j = [0], this; let b, c; a[0] instanceof S && (b = a.shift()); a.at(-1) instanceof Uint32Array && (c = a.pop()); const d = m => {
                if (m) {
                    if (m instanceof X) return [m]; if (m instanceof Ej) return m.batches; if (m instanceof O) { if (m.type instanceof re) return [new X(new S(m.type.children), m)] } else {
                        if (Array.isArray(m)) return m.flatMap(r => d(r)); if ("function" === typeof m[Symbol.iterator]) return [...m].flatMap(r => d(r)); if ("object" === typeof m) {
                            var p =
                                Object.keys(m); const r = p.map(Ia => new M([m[Ia]])); let T; const sa = null != (T = b) ? T : new S(p.map((Ia, Jc) => new U(String(Ia), r[Jc].type, r[Jc].nullable)));[, p] = Bj(sa, r); return 0 === p.length ? [new X(m)] : p
                        }
                    }
                } return []
            }; a = a.flatMap(m => d(m)); let e, f, g; b = null != (g = null != (f = b) ? f : null == (e = a[0]) ? void 0 : e.schema) ? g : new S([]); if (!(b instanceof S)) throw new TypeError("Table constructor expects a [Schema, RecordBatch[]] pair."); for (const m of a) {
                if (!(m instanceof X)) throw new TypeError("Table constructor expects a [Schema, RecordBatch[]] pair.");
                if (!wj(b, m.schema)) throw new TypeError("Table and inner RecordBatch schemas must be equivalent.");
            } this.schema = b; this.batches = a; let k; this.j = null != (k = c) ? k : Zg(this.data)
        } get data() { return this.batches.map(({ data: a }) => a) } get numCols() { return this.schema.fields.length } get numRows() { return this.data.reduce((a, b) => a + b.length, 0) } get nullCount() { -1 === this.O && (this.O = Yg(this.data)); return this.O } isValid() { return !1 } get() { return null } at(a) { return this.get(0 > a ? this.numRows + a : a) } set() { } indexOf() { return -1 } [Symbol.iterator]() {
            return 0 <
                this.batches.length ? kh.visit(new M(this.data)) : [][Symbol.iterator]()
        } toArray() { return [...this] } toString() { return `[\n  ${this.toArray().join(",\n  ")}\n]` } concat(...a) { const b = this.schema; a = this.data.concat(a.flatMap(({ data: c }) => c)); return new Ej(b, a.map(c => new X(b, c))) } slice(a, b) { const c = this.schema;[a, b] = zg({ length: this.numRows }, a, b); a = $g(this.data, this.j, a, b); return new Ej(c, a.map(d => new X(c, d))) } getChild(a) { return this.getChildAt(this.schema.fields.findIndex(b => b.name === a)) } getChildAt(a) {
            if (-1 <
                a && a < this.schema.fields.length) { const c = this.data.map(d => d.children[a]); if (0 === c.length) { var { type: b } = this.schema.fields[a]; b = P({ type: b, length: 0, nullCount: 0 }); c.push(Tg(b, this.numRows)) } return new M(c) } return null
        } setChild(a, b) { let c; return this.setChildAt(null == (c = this.schema.fields) ? void 0 : c.findIndex(d => d.name === a), b) } setChildAt(a, b) {
            let c = this.schema; var d = [...this.batches]; if (-1 < a && a < this.numCols) {
                b || (b = new M([P({ type: new Nc, length: this.numRows })])); d = c.fields.slice(); const e = d[a].clone({ type: b.type }),
                    f = this.schema.fields.map((g, k) => this.getChildAt(k));[d[a], f[a]] = [e, b];[c, d] = Bj(c, f)
            } return new Ej(c, d)
        } select(a) { const b = this.schema.fields.reduce((c, d, e) => c.set(d.name, e), new Map); return this.selectAt(a.map(c => b.get(c)).filter(c => -1 < c)) } selectAt(a) { const b = this.schema.selectAt(a), c = this.batches.map(d => d.selectAt(a)); return new Ej(b, c) } assign(a) {
            const b = this.schema.fields, [c, d] = a.schema.fields.reduce((g, k, m) => { const [p, r] = g, T = b.findIndex(sa => sa.name === k.name); ~T ? r[T] = m : p.push(m); return g }, [[], []]),
                e = this.schema.assign(a.schema), f = [...b.map((g, k) => [k, d[k]]).map(([g, k]) => void 0 === k ? this.getChildAt(g) : a.getChildAt(k)), ...c.map(g => a.getChildAt(g))].filter(Boolean); return new Ej(...Bj(e, f))
        }
    } var Fj = Symbol.toStringTag, Gj = Ej.prototype; Gj.schema = null; Gj.batches = []; Gj.j = new Uint32Array([0]); Gj.O = -1; Gj[Symbol.isConcatSpreadable] = !0; Gj.isValid = ch(bh); Gj.get = ch(Rf.getVisitFn(H.Struct)); Gj.set = dh(Cf.getVisitFn(H.Struct)); Gj.indexOf = eh(hh.getVisitFn(H.Struct)); Ej[Fj] = "Table"; class X {
        constructor(...a) {
            switch (a.length) {
                case 2: [this.schema] = a; if (!(this.schema instanceof S)) throw new TypeError("RecordBatch constructor expects a [Schema, Data] pair.");[, this.data = P({ nullCount: 0, type: new re(this.schema.fields), children: this.schema.fields.map(g => P({ type: g.type, nullCount: 0 })) })] = a; if (!(this.data instanceof O)) throw new TypeError("RecordBatch constructor expects a [Schema, Data] pair.");[this.schema, this.data] = Hj(this.schema, this.data.children); break; case 1: const [b] = a, { fields: c,
                    children: d, length: e } = Object.keys(b).reduce((g, k, m) => { g.children[m] = b[k]; g.length = Math.max(g.length, b[k].length); g.fields[m] = U.new({ name: k, type: b[k].type, nullable: !0 }); return g }, { length: 0, fields: [], children: [] }); a = new S(c); const f = P({ type: new re(c), length: e, children: d, nullCount: 0 });[this.schema, this.data] = Hj(a, f.children, e); break; default: throw new TypeError("RecordBatch constructor expects an Object mapping names to child Data, or a [Schema, Data] pair.");
            }
        } get dictionaries() {
            return this.Mb || (this.Mb =
                Ij(this.schema.fields, this.data.children))
        } get numCols() { return this.schema.fields.length } get numRows() { return this.data.length } get nullCount() { return this.data.nullCount } isValid(a) { return this.data.getValid(a) } get(a) { return Rf.visit(this.data, a) } at(a) { return this.get(0 > a ? this.numRows + a : a) } set(a, b) { return Cf.visit(this.data, a, b) } indexOf(a, b) { return hh.visit(this.data, a, b) } [Symbol.iterator]() { return kh.visit(new M([this.data])) } toArray() { return [...this] } concat(...a) {
            return new Ej(this.schema, [this,
                ...a])
        } slice(a, b) { [a] = (new M([this.data])).slice(a, b).data; return new X(this.schema, a) } getChild(a) { let b; return this.getChildAt(null == (b = this.schema.fields) ? void 0 : b.findIndex(c => c.name === a)) } getChildAt(a) { return -1 < a && a < this.schema.fields.length ? new M([this.data.children[a]]) : null } setChild(a, b) { let c; return this.setChildAt(null == (c = this.schema.fields) ? void 0 : c.findIndex(d => d.name === a), b) } setChildAt(a, b) {
            var c = this.schema, d = this.data; if (-1 < a && a < this.numCols) {
                b || (b = new M([P({ type: new Nc, length: this.numRows })]));
                const e = c.fields.slice(); d = d.children.slice(); c = e[a].clone({ type: b.type });[e[a], d[a]] = [c, b.data[0]]; c = new S(e, new Map(this.schema.metadata)); d = P({ type: new re(e), children: d })
            } return new X(c, d)
        } select(a) { const b = this.schema.select(a), c = new re(b.fields), d = []; for (const e of a) a = this.schema.fields.findIndex(f => f.name === e), ~a && (d[a] = this.data.children[a]); return new X(b, P({ type: c, length: this.numRows, children: d })) } selectAt(a) {
            const b = this.schema.selectAt(a); a = a.map(c => this.data.children[c]).filter(Boolean);
            a = P({ type: new re(b.fields), length: this.numRows, children: a }); return new X(b, a)
        }
    } var Jj = Symbol.toStringTag, Kj = X.prototype; Kj.O = -1; Kj[Symbol.isConcatSpreadable] = !0; X[Jj] = "RecordBatch";
    ...
    function Ij(a, b, c = new Map) {
        var d; if (0 < (null != (d = null == a ? void 0 : a.length) ? d : 0) && (null == a ? void 0 : a.length) === (null == b ? void 0 : b.length)) for (let f = -1, g = a.length; ++f < g;) {
            var { type: e } = a[f]; d = b[f]; let k, m; for (const p of [d, ...((null == (k = d) ? void 0 : null == (m = k.dictionary) ? void 0 : m.data) || [])]) { let r; Ij(e.children, null == (r = p) ? void 0 : r.children, c) } if (K.isDictionary(e)) if (e = e.id, !c.has(e)) { let p; (null == (p = d) ? 0 : p.dictionary) && c.set(e, d.dictionary) } else if (c.get(e) !== d.dictionary) throw Error("Cannot create Schema containing two different dictionaries with the same Id");
        } return c
    } class Lj extends X { constructor(a) { var b = a.fields.map(c => P({ type: c.type })); b = P({ type: new re(a.fields), nullCount: 0, children: b }); super(a, b) } }; class Mj {
        constructor() { this.g = null; this.h = 0 } i(a, b) { this.h = a; this.g = b; return this } version() { const a = A(this.g, this.h, 4); return a ? eb(this.g, this.h + a) : w.V1 } headerType() { const a = A(this.g, this.h, 6); return a ? this.g.l[this.h + a] : G.NONE } header(a) { const b = A(this.g, this.h, 8); return b ? gb(this.g, a, this.h + b) : null } bodyLength() { const a = A(this.g, this.h, 10); return a ? fb(this.g, this.h + a) : BigInt("0") } Ga(a) { const b = A(this.g, this.h, 12); return b ? (new Ub).i(ib(this.g, jb(this.g, this.h + b) + 4 * a), this.g) : null } Ha() {
            const a = A(this.g,
                this.h, 12); return a ? kb(this.g, this.h + a) : 0
        }
    }; class Nj extends Te {
        visit(a, b) { return null == a || null == b ? void 0 : super.visit(a, b) } visitNull(a, b) { C(b, 0); return D(b) } visitInt(a, b) { C(b, 2); tb(b, 0, a.bitWidth, 0); rb(b, 1, +a.isSigned, 0); return D(b) } visitFloat(a, b) { C(b, 1); sb(b, a.precision, y.HALF); return D(b) } visitBinary(a, b) { C(b, 0); return D(b) } visitLargeBinary(a, b) { C(b, 0); return D(b) } visitBool(a, b) { C(b, 0); return D(b) } visitUtf8(a, b) { C(b, 0); return D(b) } visitLargeUtf8(a, b) { C(b, 0); return D(b) } visitDecimal(a, b) {
            C(b, 3); tb(b, 1, a.scale, 0); tb(b, 0, a.precision, 0); tb(b,
                2, a.bitWidth, 128); return D(b)
        } visitDate(a, b) { C(b, 1); sb(b, a.unit, Xa.MILLISECOND); return D(b) } visitTime(a, b) { C(b, 2); sb(b, a.unit, z.MILLISECOND); tb(b, 1, a.bitWidth, 32); return D(b) } visitTimestamp(a, b) { const c = a.timezone && zb(b, a.timezone) || void 0; C(b, 2); sb(b, a.unit, z.SECOND); void 0 !== c && B(b, 1, c); return D(b) } visitInterval(a, b) { C(b, 1); sb(b, a.unit, $a.YEAR_MONTH); return D(b) } visitDuration(a, b) { C(b, 1); sb(b, a.unit, z.MILLISECOND); return D(b) } visitList(a, b) { C(b, 0); return D(b) } visitStruct(a, b) { C(b, 0); return D(b) } visitUnion(a,
            b) { xb(b, 4, a.typeIds.length, 4); var c = a.typeIds; xb(b, 4, c.length, 4); for (let d = c.length - 1; 0 <= d; d--)qb(b, c[d]); c = yb(b); C(b, 2); sb(b, a.mode, x.Sparse); B(b, 1, c); return D(b) } visitDictionary(a, b) { const c = this.visit(a.indices, b); C(b, 4); ub(b, 0, BigInt(a.id)); rb(b, 2, +a.isOrdered, 0); void 0 !== c && B(b, 1, c); return D(b) } visitFixedSizeBinary(a, b) { C(b, 1); tb(b, 0, a.byteWidth, 0); return D(b) } visitFixedSizeList(a, b) { C(b, 1); tb(b, 0, a.listSize, 0); return D(b) } visitMap(a, b) { C(b, 1); rb(b, 0, +a.keysSorted, 0); return D(b) }
    } const Oj = new Nj; function Pj(a) { return new Qj(a.count, Rj(a.columns), Sj(a.columns)) } function Tj(a, b) { return (a.fields || []).filter(Boolean).map(c => U.fromJSON(c, b)) } function Uj(a, b) { return (a.children || []).filter(Boolean).map(c => U.fromJSON(c, b)) } function Rj(a) { return (a || []).reduce((b, c) => [...b, new Vj(c.count, Wj(c.VALIDITY)), ...Rj(c.children)], []) }
    ...
    function ak(a, b) {
        const c = a.type.name; switch (c) { case "NONE": return new Nc; case "null": return new Nc; case "binary": return new gd; case "largebinary": return new kd; case "utf8": return new od; case "largeutf8": return new sd; case "bool": return new wd; case "list": return new ne((b || [])[0]); case "struct": return new re(b || []); case "struct_": return new re(b || []) }switch (c) {
            case "int": return b = a.type, new Oc(b.isSigned, b.bitWidth); case "floatingpoint": return new $c(y[a.type.precision]); case "decimal": return b = a.type,
                new Ad(b.scale, b.precision, b.bitWidth); case "date": return new Ed(Xa[a.type.unit]); case "time": return b = a.type, new Kd(z[b.unit], b.bitWidth); case "timestamp": return b = a.type, new Sd(z[b.unit], b.timezone); case "interval": return new $d($a[a.type.unit]); case "duration": return new fe(z[a.type.unit]); case "union": a = a.type; const [d, ...e] = (a.mode + "").toLowerCase(); return new ve(x[d.toUpperCase() + e.join("")], a.typeIds || [], b || []); case "fixedsizebinary": return new Be(a.type.byteWidth); case "fixedsizelist": return new Fe(a.type.listSize,
                    (b || [])[0]); case "map": return new Je((b || [])[0], a.type.keysSorted)
        }throw Error(`Unrecognized type: "${c}"`);
    }; class bk {
        static fromJSON(a, b) { const c = new bk(0, w.V5, b); c.Pa = ck(a, b); return c } static decode(a) { a = new lb(u(Uint8Array, a)); a = (new Mj).i(a.u(a.position()) + a.position(), a); var b = a.bodyLength(); const c = a.version(), d = a.headerType(); b = new bk(b, c, d); b.Pa = dk(a, d); return b } static encode(a) {
            const b = new Ab; let c = -1; a.isSchema() ? c = S.encode(b, a.header()) : a.isRecordBatch() ? c = Qj.encode(b, a.header()) : a.isDictionaryBatch() && (c = ek.encode(b, a.header())); C(b, 5); sb(b, w.V5, w.V1); B(b, 2, c); rb(b, 1, a.headerType, G.NONE); ub(b,
                3, BigInt(a.bodyLength)); a = D(b); b.finish(a); return mb(b)
        } static from(a, b = 0) { if (a instanceof S) return new bk(0, w.V5, G.Schema, a); if (a instanceof Qj) return new bk(b, w.V5, G.RecordBatch, a); if (a instanceof ek) return new bk(b, w.V5, G.DictionaryBatch, a); throw Error(`Unrecognized Message header: ${a}`); } get type() { return this.headerType } get version() { return this.Tb } get headerType() { return this.Pb } get bodyLength() { return this.Jb } header() { return this.Pa() } isSchema() { return this.headerType === G.Schema } isRecordBatch() {
            return this.headerType ===
                G.RecordBatch
        } isDictionaryBatch() { return this.headerType === G.DictionaryBatch } constructor(a, b, c, d) { this.Tb = b; this.Pb = c; this.body = new Uint8Array(0); d && (this.Pa = () => d); this.Jb = J(a) }
    } class Qj { get M() { return this.Ta } get length() { return this.Sb } get buffers() { return this.Na } constructor(a, b, c) { this.Ta = b; this.Na = c; this.Sb = J(a) } }
        ...
        var c = (c = A(a.g, a.h, 8)) ? a.g.l[a.h + c] : E.NONE; switch (c) { case E.NONE: return new Nc; case E.Null: return new Nc; case E.Binary: return new gd; case E.LargeBinary: return new kd; case E.Utf8: return new od; case E.LargeUtf8: return new sd; case E.Bool: return new wd; case E.List: return new ne((b || [])[0]); case E.Struct_: return new re(b || []) }switch (c) {
            case E.Int: return b = a.type(new Rb), new Oc(b.isSigned(), b.bitWidth()); case E.FloatingPoint: return b = a.type(new $b), new $c(b.precision()); case E.Decimal: return b =
                a.type(new Wb), new Ad(b.scale(), b.precision(), b.bitWidth()); case E.Date: return b = a.type(new Vb), new Ed(b.unit()); case E.Time: return b = a.type(new cc), new Kd(b.unit(), b.bitWidth()); case E.Timestamp: return b = a.type(new dc), new Sd(b.unit(), b.timezone()); case E.Interval: return b = a.type(new ac), new $d(b.unit()); case E.Duration: return b = a.type(new Xb), new fe(b.unit()); case E.Union: c = a.type(new ec); a = c.mode(); const d = A(c.g, c.h, 6); c = d ? new Int32Array(c.g.T().buffer, c.g.T().byteOffset + jb(c.g, c.h + d), kb(c.g, c.h +
                    d)) : null; return new ve(a, c || [], b || []); case E.FixedSizeBinary: return b = a.type(new Yb), new Be(b.byteWidth()); case E.FixedSizeList: return a = a.type(new Zb), new Fe(a.listSize(), (b || [])[0]); case E.Map: return a = a.type(new bc), new Je((b || [])[0], a.keysSorted())
        }throw Error(`Unrecognized type: "${E[c]}" (${c})`);
    }
    ...
    class Bk {
        constructor(a) { this.source = a instanceof Qh ? a : new Qh(a) } [Symbol.iterator]() { return this } next() { let a; return (a = this.readMetadataLength()).done || -1 === a.value && (a = this.readMetadataLength()).done || (a = this.readMetadata(a.value)).done ? Jh : a } throw(a) { return this.source.throw(a) } return(a) { return this.source.return(a) } readMessage(a) { let b; if ((b = this.next()).done) return null; if (null != a && b.value.headerType !== a) throw Error(xk(a)); return b.value } readMessageBody(a) {
            if (0 >= a) return new Uint8Array(0); const b =
                u(Uint8Array, this.source.read(a)); if (b.byteLength < a) throw Error(Ak(a, b.byteLength)); return 0 === b.byteOffset % 8 && b.byteOffset + b.byteLength <= b.buffer.byteLength ? b : b.slice()
        } readSchema(a = !1) { const b = G.Schema; let c; const d = null == (c = this.readMessage(b)) ? void 0 : c.header(); if (a && !d) throw Error(yk(b)); return d } readMetadataLength() { var a = this.source.read(4); let b; a = (null == (b = a && new lb(a)) ? void 0 : b.u(0)) || 0; return { done: 0 === a, value: a } } readMetadata(a) {
            const b = this.source.read(a); if (!b) return Jh; if (b.byteLength <
    ...
    class Ck {
        constructor(a, b) { this.source = a instanceof Sh ? a : t(a) && q(a.stat) && "number" === typeof a.fd ? new Vh(a, b) : new Sh(a) } [Symbol.asyncIterator]() { return this } next() { const a = this; return l(function* () { let b; return (b = yield a.readMetadataLength()).done || -1 === b.value && (b = yield a.readMetadataLength()).done || (b = yield a.readMetadata(b.value)).done ? Jh : b }) } throw(a) { const b = this; return l(function* () { return yield b.source.throw(a) }) } return(a) { const b = this; return l(function* () { return yield b.source.return(a) }) } readMessage(a) {
            const b =
                this; return l(function* () { let c; if ((c = yield b.next()).done) return null; if (null != a && c.value.headerType !== a) throw Error(xk(a)); return c.value })
        } readMessageBody(a) { const b = this; return l(function* () { if (0 >= a) return new Uint8Array(0); const c = u(Uint8Array, yield b.source.read(a)); if (c.byteLength < a) throw Error(Ak(a, c.byteLength)); return 0 === c.byteOffset % 8 && c.byteOffset + c.byteLength <= c.buffer.byteLength ? c : c.slice() }) } readSchema(a = !1) {
            const b = this; return l(function* () {
                const c = G.Schema; let d; const e = null == (d =
                    yield b.readMessage(c)) ? void 0 : d.header(); if (a && !e) throw Error(yk(c)); return e
            })
        } readMetadataLength() { const a = this; return l(function* () { var b = yield a.source.read(4); let c; b = (null == (c = b && new lb(b)) ? void 0 : c.u(0)) || 0; return { done: 0 === b, value: b } }) } readMetadata(a) { const b = this; return l(function* () { const c = yield b.source.read(a); if (!c) return Jh; if (c.byteLength < a) throw Error(zk(a, c.byteLength)); return { done: !1, value: bk.decode(c) } }) }
    }
    class Dk extends Bk {
        constructor(a) { super(new Uint8Array(0)); this.S = !1; this.xa = []; this.Z = this.nb = 0; this.na = a instanceof Kh ? a : new Kh(a) } next() { var a = this.na; if (!this.S) return this.S = !0, { done: !1, value: bk.fromJSON(a.schema, G.Schema) }; if (this.Z < a.dictionaries.length) return a = a.dictionaries[this.Z++], this.xa = a.data.columns, { done: !1, value: bk.fromJSON(a, G.DictionaryBatch) }; if (this.nb < a.batches.length) return a = a.batches[this.nb++], this.xa = a.columns, { done: !1, value: bk.fromJSON(a, G.RecordBatch) }; this.xa = []; return Jh } readMessageBody() {
            function a(b) {
                return (b ||
                    []).reduce((c, d) => [...c, ...(d.VALIDITY && [d.VALIDITY] || []), ...(d.TYPE_ID && [d.TYPE_ID] || []), ...(d.OFFSET && [d.OFFSET] || []), ...(d.DATA && [d.DATA] || []), ...a(d.children)], [])
            } return a(this.xa)
        } readMessage(a) { let b; if ((b = this.next()).done) return null; if (null != a && b.value.headerType !== a) throw Error(xk(a)); return b.value } readSchema() { const a = G.Schema, b = this.readMessage(a), c = null == b ? void 0 : b.header(); if (!b || !c) throw Error(yk(a)); return c }
    } const Ek = new Uint8Array(6); for (let a = 0; 6 > a; a += 1)Ek[a] = "ARROW1".codePointAt(a);
    function Fk(a) { for (let b = -1, c = Ek.length; ++b < c;)if (Ek[b] !== a[0 + b]) return !1; return !0 } const Gk = Ek.length, Hk = Gk + 4, Ik = 2 * Gk + 4; class Jk extends Nh {
        constructor(a) { super(); this.s = a } get closed() { return this.s.closed } get schema() { return this.s.schema } get autoDestroy() { return this.s.autoDestroy } get dictionaries() { return this.s.dictionaries } get numDictionaries() { return this.s.numDictionaries } get numRecordBatches() { return this.s.numRecordBatches } get footer() { return this.s.isFile() ? this.s.footer : null } isSync() { return this.s.isSync() } isAsync() { return this.s.isAsync() } isFile() { return this.s.isFile() } isStream() { return this.s.isStream() } next() { return this.s.next() } throw(a) { return this.s.throw(a) } return(a) { return this.s.return(a) } cancel() { return this.s.cancel() } reset(a) {
            this.s.reset(a);
            this.sb = this.mb = void 0; return this
        } open(a) { a = this.s.open(a); return t(a) && q(a.then) ? a.then(() => this) : this } readRecordBatch(a) { return this.s.isFile() ? this.s.readRecordBatch(a) : null } [Symbol.iterator]() { return this.s[Symbol.iterator]() } [Symbol.asyncIterator]() { return this.s[Symbol.asyncIterator]() } toDOMStream() { return La(this.isSync() ? { [Symbol.iterator]: () => this } : { [Symbol.asyncIterator]: () => this }) } toNodeStream() { return Ma(this.isSync() ? { [Symbol.iterator]: () => this } : { [Symbol.asyncIterator]: () => this }) } static throughNode() {
            throw Error('"throughNode" not available in this environment');
        } static throughDOM() { throw Error('"throughDOM" not available in this environment'); } static from(a) { return a instanceof Jk ? a : t(a) && t(a.schema) ? new Kk(new Lk(a)) : t(a) && q(a.stat) && "number" === typeof a.fd ? Mk(a) : t(a) && q(a.then) ? (() => l(function* () { return yield Jk.from(yield a) }))() : t(a) && za(a.body) || za(a) || Aa(a) || t(a) && q(a[Symbol.asyncIterator]) ? Nk(new Sh(a)) : Ok(new Qh(a)) } static readAll(a) {
            return a instanceof Jk ? a.isSync() ? Pk(a) : Qk(a) : t(a) && t(a.schema) || ArrayBuffer.isView(a) || t(a) && q(a[Symbol.iterator]) ||
                t(a) && "done" in a && "value" in a ? Pk(a) : Qk(a)
        }
    } class Kk extends Jk { constructor(a) { super(a); this.s = a } readAll() { return [...this] } [Symbol.iterator]() { return this.s[Symbol.iterator]() } [Symbol.asyncIterator]() { const a = this; return new oa(function* () { yield new n(1, a[Symbol.iterator]()) }()) } }
    ...
    class Xk extends Wk {
        constructor(a) { super(); this.v = t(a) && t(a.schema) ? new Dk(this.I = a) : new Bk(this.I = a) } isSync() { return !0 } isStream() { return !0 } [Symbol.iterator]() { return this } cancel() { !this.closed && (this.closed = !0) && (this.reset().v.return(), this.dictionaries = this.v = null) } open(a) { this.closed || (this.autoDestroy = Yk(this, a), this.schema || (this.schema = this.v.readSchema()) || this.cancel()); return this } throw(a) { return !this.closed && this.autoDestroy && (this.closed = !0) ? this.reset().v.throw(a) : Jh } return(a) {
            return !this.closed &&
                this.autoDestroy && (this.closed = !0) ? this.reset().v.return(a) : Jh
        } next() { if (this.closed) return Jh; for (var a, b = this.v; a = this.pa();)if (a.isSchema()) this.reset(a.header()); else { if (a.isRecordBatch()) { this.P++; var c = a.header(); b = b.readMessageBody(a.bodyLength); return { done: !1, value: Uk(this, c, b) } } a.isDictionaryBatch() && (this.Z++, c = a.header(), a = b.readMessageBody(a.bodyLength), a = Vk(this, c, a), this.dictionaries.set(c.id, a)) } return this.schema && 0 === this.P ? (this.P++, { done: !1, value: new Lj(this.schema) }) : this.return() } pa() { return this.v.readMessage(void 0) }
    }
    class Zk extends Wk {
        constructor(a, b) { super(b); this.v = new Ck(this.I = a) } isAsync() { return !0 } isStream() { return !0 } [Symbol.asyncIterator]() { return this } cancel() { const a = this; return l(function* () { !a.closed && (a.closed = !0) && (yield a.reset().v.return(), a.v = null, a.dictionaries = null) }) } open(a) { const b = this; return l(function* () { b.closed || (b.autoDestroy = Yk(b, a), b.schema || (b.schema = yield b.v.readSchema()) || (yield b.cancel())); return b }) } throw(a) {
            const b = this; return l(function* () {
                return !b.closed && b.autoDestroy &&
                    (b.closed = !0) ? yield b.reset().v.throw(a) : Jh
            })
        } return(a) { const b = this; return l(function* () { return !b.closed && b.autoDestroy && (b.closed = !0) ? yield b.reset().v.return(a) : Jh }) } next() {
            const a = this; return l(function* () {
                if (a.closed) return Jh; for (var b, c = a.v; b = yield a.pa();)if (b.isSchema()) yield a.reset(b.header()); else {
                    if (b.isRecordBatch()) { a.P++; var d = b.header(); c = yield c.readMessageBody(b.bodyLength); return { done: !1, value: Uk(a, d, c) } } b.isDictionaryBatch() && (a.Z++, d = b.header(), b = yield c.readMessageBody(b.bodyLength),
                        b = Vk(a, d, b), a.dictionaries.set(d.id, b))
                } return a.schema && 0 === a.P ? (a.P++, { done: !1, value: new Lj(a.schema) }) : yield a.return()
            })
        } pa() { const a = this; return l(function* () { return yield a.v.readMessage(void 0) }) }
    }
    class $k extends Xk {
        get footer() { return this.m } get numDictionaries() { return this.m ? this.m.numDictionaries : 0 } get numRecordBatches() { return this.m ? this.m.numRecordBatches : 0 } constructor(a) { super(a instanceof Uh ? a : new Uh(a)) } isSync() { return !0 } isFile() { return !0 } open(a) { if (!this.closed && !this.m) { this.schema = (this.m = this.Wa()).schema; for (const b of Fh(this.m)) b && this.Va(this.Z++) } return super.open(a) } readRecordBatch(a) {
            if (this.closed) return null; this.m || this.open(); var b; const c = null == (b = this.m) ? void 0 :
                b.ga(a); return c && this.I.seek(c.offset) && (b = this.v.readMessage(G.RecordBatch), null == b ? 0 : b.isRecordBatch()) ? (a = b.header(), b = this.v.readMessageBody(b.bodyLength), Uk(this, a, b)) : null
        } Va(a) { var b; const c = null == (b = this.m) ? void 0 : b.Ia(a); c && this.I.seek(c.offset) && (b = this.v.readMessage(G.DictionaryBatch), null == b ? 0 : b.isDictionaryBatch()) && (a = b.header(), b = this.v.readMessageBody(b.bodyLength), b = Vk(this, a, b), this.dictionaries.set(a.id, b)) } Wa() { var a = this.I; const b = a.size - Hk, c = a.u(b); a = a.ha(b - c, c); return Gh.decode(a) } pa() {
            this.m ||
    ...
    class al extends Zk {
        get footer() { return this.m } get numDictionaries() { return this.m ? this.m.numDictionaries : 0 } get numRecordBatches() { return this.m ? this.m.numRecordBatches : 0 } constructor(a) { var b = []; const c = "number" !== typeof b[0] ? b.shift() : void 0; b = b[0] instanceof Map ? b.shift() : void 0; super(a instanceof Vh ? a : new Vh(a, c), b) } isFile() { return !0 } isAsync() { return !0 } open(a) {
            const b = this, c = () => super.open; return l(function* () {
                if (!b.closed && !b.m) { b.schema = (b.m = yield b.Wa()).schema; for (const d of Fh(b.m)) d && (yield b.Va(b.Z++)) } return yield c().call(b,
                    a)
            })
        } readRecordBatch(a) { const b = this; return l(function* () { if (b.closed) return null; b.m || (yield b.open()); var c, d = null == (c = b.m) ? void 0 : c.ga(a); return d && (yield b.I.seek(d.offset)) && (d = yield b.v.readMessage(G.RecordBatch), null == d ? 0 : d.isRecordBatch()) ? (c = d.header(), d = yield b.v.readMessageBody(d.bodyLength), Uk(b, c, d)) : null }) } Va(a) {
            const b = this; return l(function* () {
                var c, d = null == (c = b.m) ? void 0 : c.Ia(a); d && (yield b.I.seek(d.offset)) && (d = yield b.v.readMessage(G.DictionaryBatch), null == d ? 0 : d.isDictionaryBatch()) &&
                    (c = d.header(), d = yield b.v.readMessageBody(d.bodyLength), d = Vk(b, c, d), b.dictionaries.set(c.id, d))
            })
        } Wa() { const a = this; return l(function* () { var b = a.I; b.G && (yield b.G); const c = b.size - Hk, d = yield b.u(c); b = yield b.ha(c - d, d); return Gh.decode(b) }) } pa() { const a = this; return l(function* () { a.m || (yield a.open()); if (a.m && a.P < a.numRecordBatches) { const b = a.m.ga(a.P); if (b && (yield a.I.seek(b.offset))) return yield a.v.readMessage(void 0) } return null }) }
    }
    ...
    function Nk(a) { return l(function* () { const b = yield a.peek(Gk + 7 & -8); return b && 4 <= b.byteLength ? Fk(b) ? new Sk(new $k(yield a.read())) : new Rk(new Zk(a)) : new Rk(new Zk(function () { return new oa(function* () { }()) }())) }) } function Mk(a) { return l(function* () { const { size: b } = yield a.stat(), c = new Vh(a, b); return b >= Ik && Fk(yield c.ha(0, Gk + 7 & -8)) ? new Tk(new al(c)) : new Rk(new Zk(c)) }) }; class bl extends Te {
        static sa(...a) { const b = d => d.flatMap(e => Array.isArray(e) ? b(e) : e instanceof X ? e.data.children : e.data), c = new bl; c.visitMany(b(a)); return c } constructor() { super(); this.ya = 0; this.Ta = []; this.Na = []; this.Kb = [] } visit(a) {
            if (a instanceof M) return this.visitMany(a.data), this; const b = a.type; if (!K.isDictionary(b)) {
                const c = a.length; if (2147483647 < c) throw new RangeError("Cannot write arrays larger than 2^31 - 1 in length"); if (K.isUnion(b)) this.M.push(new Vj(c, 0)); else {
                    const d = a.nullCount; K.isNull(b) ||
                        cl.call(this, 0 >= d ? new Uint8Array(0) : Lg(a.offset, c, a.nullBitmap)); this.M.push(new Vj(c, d))
                }
            } return super.visit(a)
        } visitNull() { return this } visitDictionary(a) { return this.visit(a.clone(a.type.indices)) } get M() { return this.Ta } get buffers() { return this.Na } get byteLength() { return this.ya } get ab() { return this.Kb }
    } function cl(a) { const b = a.byteLength + 7 & -8; this.buffers.push(a); this.ab.push(new Xj(this.ya, b)); this.ya += b; return this } function dl(a) { return cl.call(this, a.values.subarray(0, a.length * a.stride)) }
    ...
    h.visitUnion = function (a) {
        const b = a.type, c = a.length, d = a.typeIds, e = a.valueOffsets; cl.call(this, d); if (b.mode === x.Sparse) return gl.call(this, a); if (b.mode === x.Dense) {
            if (0 >= a.offset) return cl.call(this, e), gl.call(this, a); const f = new Int32Array(c), g = Object.create(null), k = Object.create(null); for (let m, p, r = -1; ++r < c;) { if (void 0 === (m = d[r])) continue; void 0 === (p = g[m]) && (p = g[m] = e[r]); f[r] = e[r] - p; let T; k[m] = (null != (T = k[m]) ? T : 0) + 1 } cl.call(this, f); this.visitMany(a.children.map((m, p) => {
                p = b.typeIds[p]; return m.slice(g[p],
                    Math.min(c, k[p]))
            }))
        } return this
    }; h.visitInterval = dl; h.visitDuration = dl; h.visitFixedSizeList = fl; h.visitMap = fl; class hl extends Te {
        visit(a) { return null == a ? void 0 : super.visit(a) } visitNull({ typeId: a }) { return { name: E[a].toLowerCase() } } visitInt({ typeId: a, bitWidth: b, isSigned: c }) { return { name: E[a].toLowerCase(), bitWidth: b, isSigned: c } } visitFloat({ typeId: a, precision: b }) { return { name: E[a].toLowerCase(), precision: y[b] } } visitBinary({ typeId: a }) { return { name: E[a].toLowerCase() } } visitLargeBinary({ typeId: a }) { return { name: E[a].toLowerCase() } } visitBool({ typeId: a }) { return { name: E[a].toLowerCase() } } visitUtf8({ typeId: a }) { return { name: E[a].toLowerCase() } } visitLargeUtf8({ typeId: a }) { return { name: E[a].toLowerCase() } } visitDecimal({ typeId: a,
            scale: b, precision: c, bitWidth: d }) { return { name: E[a].toLowerCase(), scale: b, precision: c, bitWidth: d } } visitDate({ typeId: a, unit: b }) { return { name: E[a].toLowerCase(), unit: Xa[b] } } visitTime({ typeId: a, unit: b, bitWidth: c }) { return { name: E[a].toLowerCase(), unit: z[b], bitWidth: c } } visitTimestamp({ typeId: a, timezone: b, unit: c }) { return { name: E[a].toLowerCase(), unit: z[c], timezone: b } } visitInterval({ typeId: a, unit: b }) { return { name: E[a].toLowerCase(), unit: $a[b] } } visitDuration({ typeId: a, unit: b }) {
                return {
                    name: E[a].toLocaleLowerCase(),
                    unit: z[b]
                }
            } visitList({ typeId: a }) { return { name: E[a].toLowerCase() } } visitStruct({ typeId: a }) { return { name: E[a].toLowerCase() } } visitUnion({ typeId: a, mode: b, typeIds: c }) { return { name: E[a].toLowerCase(), mode: x[b].toUpperCase(), typeIds: [...c] } } visitDictionary(a) { return this.visit(a.dictionary) } visitFixedSizeBinary({ typeId: a, byteWidth: b }) { return { name: E[a].toLowerCase(), byteWidth: b } } visitFixedSizeList({ typeId: a, listSize: b }) { return { name: E[a].toLowerCase(), listSize: b } } visitMap({ typeId: a, keysSorted: b }) {
                return {
                    name: E[a].toLowerCase(),
                    keysSorted: b
                }
            }
    }; class il extends Te {
        static sa(...a) { const b = new il; return a.map(({ schema: c, data: d }) => b.visitMany(c.fields, d.children)) } visit({ name: a }, b) { const c = b.length, d = b.offset, e = b.nullCount, f = b.nullBitmap, g = K.isDictionary(b.type) ? b.type.indices : b.type, k = Object.assign([], b.buffers, { [sc.VALIDITY]: void 0 }); return Object.assign({}, { name: a, count: c, VALIDITY: K.isNull(g) || K.isUnion(g) ? void 0 : 0 >= e ? Array.from({ length: c }, () => 1) : [...(new Ng(f, d, c, null, Kg))] }, super.visit(b.clone(g, d, c, 0, k))) } visitNull() { return {} } visitBool({ values: a,
            offset: b, length: c }) { return { DATA: [...(new Ng(a, b, c, null, Jg))] } } visitInt(a) { return { DATA: 64 > a.type.bitWidth ? [...a.values] : [...jl(a.values, 2)] } } visitFloat(a) { return { DATA: [...a.values] } } visitUtf8(a) { return { DATA: [...(new M([a]))], OFFSET: [...a.valueOffsets] } } visitLargeUtf8(a) { return { DATA: [...(new M([a]))], OFFSET: [...jl(a.valueOffsets, 2)] } } visitBinary(a) { return { DATA: [...kl(new M([a]))], OFFSET: [...a.valueOffsets] } } visitLargeBinary(a) { return { DATA: [...kl(new M([a]))], OFFSET: [...jl(a.valueOffsets, 2)] } } visitFixedSizeBinary(a) { return { DATA: [...kl(new M([a]))] } } visitDate(a) {
                return {
                    DATA: a.type.unit ===
                        Xa.DAY ? [...a.values] : [...jl(a.values, 2)]
                }
            } visitTimestamp(a) { return { DATA: [...jl(a.values, 2)] } } visitTime(a) { return { DATA: a.type.unit < z.MICROSECOND ? [...a.values] : [...jl(a.values, 2)] } } visitDecimal(a) { return { DATA: [...jl(a.values, 4)] } } visitList(a) { return { OFFSET: [...a.valueOffsets], children: this.visitMany(a.type.children, a.children) } } visitStruct(a) { return { children: this.visitMany(a.type.children, a.children) } } visitUnion(a) {
                return {
                    TYPE_ID: [...a.typeIds], OFFSET: a.type.mode === x.Dense ? [...a.valueOffsets] : void 0,
                    children: this.visitMany(a.type.children, a.children)
                }
            } visitInterval(a) { return { DATA: [...a.values] } } visitDuration(a) { return { DATA: [...jl(a.values, 2)] } } visitFixedSizeList(a) { return { children: this.visitMany(a.type.children, a.children) } } visitMap(a) { return { OFFSET: [...a.valueOffsets], children: this.visitMany(a.type.children, a.children) } }
    } function* kl(a) { for (const b of a) yield b.reduce((c, d) => `${c}${("0" + (d & 255).toString(16)).slice(-2)}`, "").toUpperCase() }
    ...
    class nl extends Nh {
        static throughNode() { throw Error('"throughNode" not available in this environment'); } static throughDOM() { throw Error('"throughDOM" not available in this environment'); } constructor(a) { super(); this.oa = 0; this.qa = !1; this.H = new Ph; this.S = null; this.ma = []; this.Aa = []; this.Ca = new Map; this.Qa = new Map; t(a) || (a = { autoDestroy: !0, Gb: !1 }); this.wa = "boolean" === typeof a.autoDestroy ? a.autoDestroy : !0; this.Xa = "boolean" === typeof a.Gb ? a.Gb : !1 } toString(a = !1) { return this.H.toString(a) } toUint8Array(a = !1) { return this.H.toUint8Array(a) } writeAll(a) {
            return t(a) &&
                q(a.then) ? a.then(b => this.writeAll(b)) : t(a) && q(a[Symbol.asyncIterator]) ? ol(this, a) : pl(this, a)
        } get closed() { return this.H.closed } [Symbol.asyncIterator]() { return this.H[Symbol.asyncIterator]() } toDOMStream(a) { return this.H.toDOMStream(a) } toNodeStream(a) { return this.H.toNodeStream(a) } close() { return this.reset().H.close() } abort(a) { return this.reset().H.abort(a) } finish() { this.wa ? this.close() : this.reset(this.H, this.S); return this } reset(a = this.H, b = null) {
            a === this.H || a instanceof Ph ? this.H = a : (this.H = new Ph,
            ...
            let b = null; if (this.H) {
                if (null == a || a instanceof Ej && !(b = a.schema) || a instanceof X && !(b = a.schema)) return this.finish() &&
                    void 0
            } else throw Error("RecordBatchWriter is closed"); if (b && !wj(b, this.S)) { if (this.qa && this.wa) return this.close(); this.reset(this.H, b) } a instanceof X ? a instanceof Lj || this.ub(a) : a instanceof Ej ? this.writeAll(a.batches) : t(a) && q(a[Symbol.iterator]) && this.writeAll(a)
        } Fa(a) {
            const b = bk.encode(a), c = b.byteLength, d = this.Xa ? 4 : 8, e = c + d + 7 & -8, f = e - c - d; a.headerType === G.RecordBatch ? this.Aa.push(new Ih(e, a.bodyLength, this.oa)) : a.headerType === G.DictionaryBatch && this.ma.push(new Ih(e, a.bodyLength, this.oa)); this.Xa ||
                Y(this, Int32Array.of(-1)); Y(this, Int32Array.of(e - d)); 0 < c && Y(this, b); return ll(this, f)
        } Ya(a) { this.Fa(bk.from(a)) } Ea() { return this.Xa ? Y(this, Int32Array.of(0)) : Y(this, Int32Array.of(-1, 0)) } ub(a) { const { byteLength: b, M: c, ab: d, buffers: e } = bl.sa(a); var f = new Qj(a.numRows, c, d); f = bk.from(f, b); ml(this.Da(a).Fa(f), e) } ra(a, b, c = !1) { const { byteLength: d, M: e, ab: f, buffers: g } = bl.sa(new M([a])); a = new Qj(a.length, e, f); b = new ek(a, b, c); b = bk.from(b, d); return ml(this.Fa(b), g) } Da(a) {
            for (const [b, c] of a.dictionaries) {
                let d,
                    e; a = null != (e = null == (d = c) ? void 0 : d.data) ? e : []; const f = this.Ca.get(b); let g; const k = null != (g = this.Qa.get(b)) ? g : 0; if (!f || f.data[0] !== a[0]) for (const [m, p] of a.entries()) this.ra(p, b, 0 < m); else if (k < a.length) for (const m of a.slice(k)) this.ra(m, b, !0); this.Ca.set(b, c); this.Qa.set(b, a.length)
            } return this
        }
    } class ql extends nl { static writeAll(a, b) { const c = new ql(b); return t(a) && q(a.then) ? a.then(d => c.writeAll(d)) : t(a) && q(a[Symbol.asyncIterator]) ? ol(c, a) : pl(c, a) } }
    ...
    class sl extends nl {
        static writeAll(a) { return (new sl).writeAll(a) } constructor() { super(); this.wa = !0; this.ba = []; this.Ba = [] } Fa() { return this } Ea() { return this } Ya(a) { Y(this, `{\n  "schema": ${JSON.stringify({ fields: a.fields.map(b => tl(b)) }, null, 2)}`) } Da(a) { 0 < a.dictionaries.size && this.Ba.push(a); return this } ra(a, b, c = !1) { Y(this, 0 === this.ma.length ? "    " : ",\n    "); Y(this, ul(a, b, c)); this.ma.push(new Ih(0, 0, 0)); return this } ub(a) { this.Da(a); this.ba.push(a) } close() {
            if (0 < this.Ba.length) {
                Y(this, ',\n  "dictionaries": [\n');
                for (var a of this.Ba) super.Da(a); Y(this, "\n  ]")
            } if (0 < this.ba.length) { for (let b = -1, c = this.ba.length; ++b < c;) { Y(this, 0 === b ? ',\n  "batches": [\n    ' : ",\n    "); a = this.ba[b]; const [d] = il.sa(a); a = JSON.stringify({ count: a.numRows, columns: d }, null, 2); Y(this, a); this.Aa.push(new Ih(0, 0, 0)) } Y(this, "\n  ]") } this.S && Y(this, "\n}"); this.Ba = []; this.ba = []; return super.close()
        }
    } function pl(a, b) { let c = b; b instanceof Ej && (c = b.batches, a.reset(void 0, b.schema)); for (const d of c) a.write(d); return a.finish() }
    ...
    function ul(a, b, c = !1) { const [d] = il.sa(new X({ [b]: a })); return JSON.stringify({ id: b, isDelta: c, data: { count: a.length, columns: d } }, null, 2) }; function vl(a, b) {
        function c(g, k) { let m, p, r = g.desiredSize || null; for (; !(p = k.next(e ? r : null)).done;)if (ArrayBuffer.isView(p.value) && (m = u(Uint8Array, p.value)) && (null != r && e && (r = r - m.byteLength + 1), p.value = m), g.enqueue(p.value), null != r && 0 >= --r) return; g.close() } let d = null; const e = "bytes" === (null == b ? void 0 : b.type) || !1, f = (null == b ? void 0 : b.highWaterMark) || Math.pow(2, 24); return new ReadableStream(Object.assign({}, b, {
            start(g) { c(g, d || (d = a[Symbol.iterator]())) }, pull(g) { d ? c(g, d) : g.close() }, cancel() {
                let g; (null == (g =
                    d) ? 0 : g.return) && d.return(); d = null
            }
        }), Object.assign({}, { highWaterMark: e ? f : void 0 }, b))
    }
    function wl(a, b) {
        function c(g, k) { return l(function* () { let m, p, r = g.desiredSize || null; for (; !(p = yield k.next(e ? r : null)).done;)if (ArrayBuffer.isView(p.value) && (m = u(Uint8Array, p.value)) && (null != r && e && (r = r - m.byteLength + 1), p.value = m), g.enqueue(p.value), null != r && 0 >= --r) return; g.close() }) } let d = null; const e = "bytes" === (null == b ? void 0 : b.type) || !1, f = (null == b ? void 0 : b.highWaterMark) || Math.pow(2, 24); return new ReadableStream(Object.assign({}, b, {
            start(g) { return l(function* () { yield c(g, d || (d = a[Symbol.asyncIterator]())) }) },
            pull(g) { return l(function* () { d ? yield c(g, d) : g.close() }) }, cancel() { return l(function* () { let g; (null == (g = d) ? 0 : g.return) && (yield d.return()); d = null }) }
        }), Object.assign({}, { highWaterMark: e ? f : void 0 }, b))
    }; function xl(a, b, c) { null != c && (a.ka >= c.desiredSize && ++a.Ua && yl(a, c, b.toVector()), b.finished && ((0 < b.length || 0 === a.Ua) && ++a.Ua && yl(a, c, b.toVector()), !a.pb && (a.pb = !0) && yl(a, c, null))) } function yl(a, b, c) { a.ka = 0; a.la = null; null == c ? b.close() : b.enqueue(c) }
    class zl {
        constructor(a) {
            this.Ua = 0; this.pb = !1; this.ka = 0; var b = Object.assign({}, a), c = a.readableStrategy, d = a.writableStrategy; a = a.queueingStrategy; a = void 0 === a ? "count" : a; b = (delete b.readableStrategy, delete b.writableStrategy, delete b.queueingStrategy, b); this.la = null; this.da = pi(b); this.Ob = "bytes" !== a ? Al : Bl; ({ highWaterMark: c = "bytes" === a ? Math.pow(2, 14) : 1E3 } = Object.assign({}, c)); ({ highWaterMark: d = "bytes" === a ? Math.pow(2, 14) : 1E3 } = Object.assign({}, d)); this.readable = new ReadableStream({
                cancel: () => { this.da.clear() },
                pull: e => { xl(this, this.da, this.la = e) }, start: e => { xl(this, this.da, this.la = e) }
            }, { highWaterMark: c, size: "bytes" !== a ? Al : Bl }); this.writable = new WritableStream({ abort: () => { this.da.clear() }, write: () => { xl(this, this.da, this.la) }, close: () => { xl(this, this.da.finish(), this.la) } }, { highWaterMark: d, size: e => { const f = this.ka; this.ka = this.Ob(this.da.append(e)); return this.ka - f } })
        }
    } const Al = a => { let b; return null != (b = null == a ? void 0 : a.length) ? b : 0 }, Bl = a => { let b; return null != (b = null == a ? void 0 : a.byteLength) ? b : 0 }; function Cl(a, b) {
        function c() { return l(function* () { return yield (yield Jk.from(e)).open(b) }) } function d(k, m) { return l(function* () { let p = k.desiredSize, r; for (; !(r = yield m.next()).done;)if (k.enqueue(r.value), null != p && 0 >= --p) return; k.close() }) } const e = new Ph; let f = null; const g = new ReadableStream({ cancel() { return l(function* () { yield e.close() }) }, start(k) { return l(function* () { yield d(k, f || (f = yield c())) }) }, pull(k) { return l(function* () { f ? yield d(k, f) : k.close() }) } }); return {
            writable: new WritableStream(e, Object.assign({},
                { highWaterMark: Math.pow(2, 14) }, a)), readable: g
        }
    }; function Dl(a, b) { function c(f) { return l(function* () { let g, k = f.desiredSize; for (; g = yield e.read(k || null);)if (f.enqueue(g), null != k && 0 >= (k -= g.byteLength)) return; f.close() }) } const d = new this(a), e = new Sh(d); b = new ReadableStream({ cancel() { return l(function* () { yield e.cancel() }) }, pull(f) { return l(function* () { yield c(f) }) }, start(f) { return l(function* () { yield c(f) }) } }, Object.assign({}, { highWaterMark: Math.pow(2, 14) }, b)); return { writable: new WritableStream(d, a), readable: b } }; function El(a) { a = Jk.from(a); return t(a) && q(a.then) ? a.then(b => El(b)) : a.isAsync() ? a.readAll().then(b => new Ej(b)) : new Ej(a.readAll()) }; const Fl = Object.assign({}, Ic, ci, Rg, af, v, Ig, vc, { compareSchemas: wj, compareFields: function (a, b) { return tj.compareFields(a, b) }, compareTypes: xj }); La = function (a, b) { if (t(a) && q(a[Symbol.asyncIterator])) return wl(a, b); if (t(a) && q(a[Symbol.iterator])) return vl(a, b); throw Error("toDOMStream() must be called with an Iterable or AsyncIterable"); }; xh.throughDOM = function (a) { return new zl(a) }; Jk.throughDOM = Cl; Sk.throughDOM = Cl; Kk.throughDOM = Cl; nl.throughDOM = Dl; rl.throughDOM = Dl; ql.throughDOM = Dl; var Z = {}; Z.AsyncByteQueue = Ph; Z.AsyncByteStream = Sh; Z.AsyncMessageReader = Ck; Z.AsyncRecordBatchFileReader = Tk; Z.AsyncRecordBatchStreamReader = Rk; Z.Binary = gd;
    ...
    Z.builderThroughAsyncIterable = function (a) {
        const { queueingStrategy: b = "count" } = a, { highWaterMark: c = "bytes" !== b ? Number.POSITIVE_INFINITY : Math.pow(2, 14) } = a, d = "bytes" !== b ? "length" : "byteLength"; return function (e) {
            return new oa(function* () {
                let f = 0; const g = pi(a); var k; try { for (var m = ia(e); ;) { var p = yield new n(2, m.next()); if (p.done) break; g.append(p.value)[d] >= c && ++f && (yield new n(0, g.toVector())) } } catch (T) { var r = { error: T } } finally {
                    try { p && !p.done && (k = m.return) && (yield new n(2, k.call(m))) } finally {
                        if (r) throw r.error;
                    }
                } if (0 < g.finish().length || 0 === f) yield new n(0, g.toVector())
            }())
        }
    }; Z.builderThroughIterable = Aj; Z.makeBuilder = pi; Z.makeData = P; Z.makeTable = function (a) { const b = {}; a = Object.entries(a); for (const [c, d] of a) b[c] = oh(d); return new Ej(b) }; Z.makeVector = oh; Z.tableFromArrays = function (a) { const b = {}; a = Object.entries(a); for (const [c, d] of a) b[c] = yj(d); return new Ej(b) }; Z.tableFromIPC = El; Z.tableFromJSON = function (a) { a = yj(a); a = new X(new S(a.type.children), a.data[0]); return new Ej(a) };
    Z.tableToIPC = function (a, b = "stream") { return ("stream" === b ? ql : rl).writeAll(a).toUint8Array(!0) }; Z.util = Fl; Z.vectorFromArray = yj; Object.assign(arguments[0], Z);
}.bind(this))));
